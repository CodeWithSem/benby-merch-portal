...
export const resolve_unit_price = ({
  ...
  if (!item_code || !Array.isArray(price_proc_list)) {
    return { price: 0, record: null };
  }
  ...
  const matched_record = find_match();

  return {
    price: matched_record ? Number(matched_record.current_price || 0) : 0,
    record: matched_record, // This is the "array" (object) that was selected
  };
};
