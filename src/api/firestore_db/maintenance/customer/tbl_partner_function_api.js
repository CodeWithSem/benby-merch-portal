...
// - [Get]
// + [Create]
export const api_create_partner_function = async (
  new_data,
  user,
  show_toast
) => {
  try {
    ...
    // ---------------------------------------------
    // 1. CHECK DUPLICATE partner_function_code
    // ---------------------------------------------
    const q_code = query(
      tbl_partner_function_ref,
      where("partner_function_code", "==", new_data.partner_function_code)
    );
    ...
    // ---------------------------------------------
    // 2. CHECK DUPLICATE partner_function_desc
    // ---------------------------------------------
    const q_desc = query(
      tbl_partner_function_ref,
      where("partner_function_desc", "==", new_data.partner_function_desc)
    );
...
// - [Update Incremental ID]
// + [Update]
export const api_update_partner_function = async (
  edit_data,
  user,
  show_toast
) => {
  try {
    ...
    const tbl_path = get_firestore_path(TABLES.PARTNER_FUNCTION);
    const tbl_partner_function_ref = collection(firestore_db, ...tbl_path);

    // ---------------------------------------------------
    // 1. CHECK DUPLICATE partner_function_desc (exclude same ID)
    // ---------------------------------------------------
    const q_desc = query(
      tbl_partner_function_ref,
      where("partner_function_desc", "==", edit_data.partner_function_desc)
    );
...
export const api_set_partner_function_increment = async (new_id) => {
