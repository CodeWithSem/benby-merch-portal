        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="grid grid-cols-2 gap-16 w-full max-w-[1000px]">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              >
                Enter {quantity_type === "COMPLETE" ? "Completed" : "Rejected"}{" "}
                Quantity
              </div>

              <div
                className={`w-full h-[120px] rounded-xl border-2 flex items-center justify-center text-4xl font-bold ${
                  quantity_type === "COMPLETE"
                    ? "border-green-500"
                    : "border-red-500"
                }`}
