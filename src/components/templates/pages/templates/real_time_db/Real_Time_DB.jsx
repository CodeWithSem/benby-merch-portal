// src/components/Real_Time_DB.jsx
...
const Real_Time_DB = () => {
  ...
  // onValue
  //   useEffect(() => {
  //     const unsubscribe = subscribe_users((users) => {
  //       set_all_data(users);
  //     });
  ...
  const handle_add_user = async () => {
    try {
      ...
      // ✅ Instantly add to your table
      set_all_data((prev) => [new_user, ...prev]);

      show_toast({
        type: "success",
        title: "Added!",
        message: "User added to Realtime DB.",
  ...
  return (
    <div className="w-full">
      <div className="flex flex-wrap items-center justify-between gap-3 py-5">
        <h1 className="text-xl">Realtime Database Table</h1>
      </div>
