        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Text_Field
              ...
              value={edit_item_data.std_ltc_std_code} //--> std_ltc_std_code
          ...
          <div>
            <Text_Field
              ...
              type={"text"}
              placeholder="Enter code"
              value={edit_item_data.std_industry_std_code} //--> std_industry_std_code
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div>
            <Find_Field
              label="Item Status"
              value={get_description(
                edit_item_data.std_item_status_code,
                item_status_list,
                "item_status_code",
                "item_status_desc"
          ...
          <div>
            <Date_Field
              ...
              value={edit_item_data.std_valid_from} //--> std_valid_from
          ...
          <div>
            <Date_Field
              label="Validity To"
              placeholder="MM-DD-YYYY"
              value={edit_item_data.std_valid_to} //--> std_valid_to
          ...
          <div>
            <Select_Field
              ...
              options={uom_options}
              value={edit_item_data.std_base_uom || ""} //--> std_base_uom
          ...
          <div className="mt-4 flex items-end col-span-full">
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={edit_item_data.std_batch_management} //--> std_batch_management
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Text_Field
              ...
              type={"number"}
              placeholder="0"
              value={edit_item_data.std_gross_weight} //--> std_gross_weight
          ...
          <div>
            <Select_Field
              ...
              options={uom_options}
              value={edit_item_data.std_gross_weight_uom || ""} //--> std_gross_weight_uom
          ...
          <div>
            <Text_Field
              ...
              type={"number"}
              placeholder="0"
              value={edit_item_data.std_net_weight} //--> std_net_weight
          ...
          <div>
            <Select_Field
              ...
              options={uom_options}
              value={edit_item_data.std_net_weight_uom || ""} //--> std_net_weight_uom
          ...
          <div>
            <Text_Field
              ...
              type={"number"}
              placeholder="0"
              value={edit_item_data.std_item_volume} //--> std_item_volume
          ...
          <div>
            <Select_Field
              ...
              options={uom_options}
              value={edit_item_data.std_item_volume_uom || ""} //--> std_item_volume_uom
          ...
          <div>
            <Text_Field
              ...
              placeholder="0"
              int_only={true}
              value={edit_item_data.std_size_packing} //--> std_size_packing
          ...
          <div>
            <Text_Field
              ...
              type={"number"}
              placeholder="0"
              value={edit_item_data.std_item_unit_per_liter} //--> std_item_unit_per_liter
