...
const Case_Config_2 = ({ edit_item_data, set_edit_item_data }) => {
        ...
        <div className="grid grid-cols-1 gap-5">
          <div>
            <Textarea_Field
              ...
              height="120px"
              value={edit_item_data.cc2_inspect_remarks} //--> cc2_inspect_remarks
          ...
          <div>
            <Textarea_Field
              ...
              height="120px"
              value={edit_item_data.cc2_internal_comments} //--> cc2_internal_comments
          ...
          <div>
            <Textarea_Field
              ...
              height="120px"
              value={edit_item_data.cc2_base_cs_config_notes} //--> cc2_base_cs_config_notes
