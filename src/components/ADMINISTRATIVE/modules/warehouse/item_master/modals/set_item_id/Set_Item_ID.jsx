...
import { api_set_item_master_increment } from "api/firestore_db/warehouse/item_master/tbl_item_master_api";
...
const Set_Item_ID = ({
  ...
  const handle_set_id = async () => {
    try {
      ...
      const response = await api_set_item_master_increment(num_id);
