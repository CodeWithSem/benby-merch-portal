        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div>
            <Text_Field_Adorn
              ...
              adornment={new_item_data.std_gross_weight_uom} //--> same as std_gross_weight_uom
              disabled
            />
          </div>
          <div>
            <Select_Field
              ...
              options={uom_options}
              value={new_item_data.wm1_wm_uom || ""} //--> wm1_wm_uom
          ...
          <div>
            <Text_Field_Adorn
              ...
              adornment={new_item_data.std_net_weight_uom} //--> same as std_net_weight_uom
              disabled
            />
          </div>
          <div>
            <Select_Field
              label="Unit of Issue"
              options={uom_options}
              value={new_item_data.wm1_issue_uom || ""} //--> wm1_issue_uom
          ...
          <div>
            <Text_Field_Adorn
              ...
              adornment={new_item_data.std_item_volume_uom} //--> same as std_item_volume_uom
              disabled
            />
          </div>
          <div>
            <Select_Field
              ...
              options={uom_options}
              value={new_item_data.wm1_proposed_uom || ""} //--> wm1_proposed_uom
          ...
          <div className="flex gap-2">
            <div className="w-full">
              <Text_Field
                ...
                type={"number"}
                placeholder="0"
                value={new_item_data.wm1_cap_usage} //--> wm1_cap_usage
            ...
            <div className="pt-[24px] w-[250px]">
              <Select_Field
                options={uom_options}
                value={new_item_data.wm1_cap_usage_uom || ""} //--> wm1_cap_usage_uom
          ...
          <div className="flex gap-2">
            <div className="w-full">
              <Text_Field
                ...
                type={"number"}
                placeholder="0"
                value={new_item_data.wm1_picking_stype} //--> wm1_picking_stype
            ...
            <div className="pt-[24px] w-[250px]">
              <Select_Field
                options={uom_options}
                value={new_item_data.wm1_picking_stype_uom || ""} //--> wm1_picking_stype_uom
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Find_Field
              ...
              value={get_description(
                new_item_data.wm1_stock_source_code,
                stype_list,
                "stype_code",
                "stype_desc"
          ...
          <div>
            <Find_Field
              label="Stock Destination"
              value={get_description(
                new_item_data.wm1_stock_dest_code,
                stype_list,
                "stype_code",
                "stype_desc"
              )} //--> wm1_stock_dest_code
          ...
          <div>
            <Find_Field
              label="Storage Section Indicator"
              value={get_description(
                new_item_data.wm1_ssec_ind_code,
                ssec_ind_list,
                "ssec_ind_code",
                "ssec_ind_desc"
              )} //--> wm1_ssec_ind_code
          ...
          <div className="mt-4 flex items-end col-span-full">
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={new_item_data.wm1_picking_type} //--> wm1_picking_type
          ...
          <div className="mt-4 flex items-end col-span-full">
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={new_item_data.wm1_permit_add_stock} //--> wm1_permit_add_stock
