...
const Item_Details = ({ edit_sbin_data }) => {
  // RETURN ORIGIN
  return (
    <React.Fragment>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="col-span-full">
            <Text_Field
              label="LPN Number"
              type={"text"}
              value={edit_sbin_data.current_lpn_no}
              disabled
            />
          </div>
          <div className="col-span-full">
          ...
          <div>
            <Text_Field
              ...
              type={"text"}
              value={edit_sbin_data.current_manufacture_date}
              disabled
            />
          </div>
          <div>
            <Text_Field
              label="SLED / BBD"
              type={"text"}
              value={edit_sbin_data.current_sled_bbd}
              disabled
            />
          </div>
          <div>
            <Text_Field
              label="Pallet Config"
              type={"text"}
              value={edit_sbin_data.current_pallet_config}
              disabled
            />
          </div>
          <div>
            <Text_Field
              ...
              type={"text"}
              value={edit_sbin_data.current_sutype}
              disabled
            />
          </div>
        </div>
