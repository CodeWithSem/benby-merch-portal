...
const SBIN_Details = ({
  ...
  const handle_select_change = handle_select_change_function(set_new_sbin_data);
  const handle_text_change = handle_text_change_function(set_new_sbin_data);
  const handle_checkbox_change =
    handle_checkbox_change_function(set_new_sbin_data);
  // RETURN ORIGIN
  return (
    <React.Fragment>
        ...
        <div className="grid grid-cols-1 gap-5">
          <div>
            <Text_Code_Field
              ...
              code_value={new_sbin_data.sbtype_code}
              text_value={get_description(
                new_sbin_data.sbtype_code,
                sbtype_list,
                "sbtype_code",
                "sbtype_desc"
              )}
          ...
          <div>
            <Text_Code_Field
              ...
              code_width="150px"
              show_search_button={true}
              code_value={new_sbin_data.ssec_code}
              text_value={get_description(
                new_sbin_data.ssec_code,
                ssec_list,
                "ssec_code",
                "ssec_desc"
              )}
          ...
          <div>
            <Text_Code_Field
              ...
              code_width="150px"
              show_search_button={true}
              code_value={new_sbin_data.pick_area_code}
              text_value={get_description(
                new_sbin_data.pick_area_code,
                pick_area_list,
                "pick_area_code",
                "pick_area_desc"
              )}
        ...
        <div className="grid grid-cols-1 gap-5">
          <div>
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={new_sbin_data.block_putaway_stock} //--> block_putaway_stock
          ...
          <div>
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={new_sbin_data.physical_inventory} //--> physical_inventory
          ...
          <div>
            <Textarea_Field
              ...
              height="120px"
              value={new_sbin_data.sbin_block_reason} //--> sbin_block_reason
