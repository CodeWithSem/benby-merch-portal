  ...
  return (
    <React.Fragment>
            ...
            <div className="grid grid-cols-1 gap-5">
              ...
              <div>
                <Text_Code_Field
                  ...
                  code_value={new_batch_data.warehouse_code}
                  text_value={get_description(
                    new_batch_data.warehouse_code,
                    warehouse_list,
                    "warehouse_code",
                    "warehouse_desc",
                  )}
              ...
              <div>
                <Text_Code_Field
                  ...
                  code_width="150px"
                  show_search_button={!!new_batch_data.warehouse_code}
      ...
      <Select_SLOC
        ...
        width="max-w-[1000px]"
        height="max-h-[700px]"
        selected_warehouse_code={new_batch_data.warehouse_code}
        warehouse_list={warehouse_list}
        sloc_list={sloc_list}
      ...
      <Select_Item
        ...
        warehouse_code={new_batch_data.warehouse_code}
