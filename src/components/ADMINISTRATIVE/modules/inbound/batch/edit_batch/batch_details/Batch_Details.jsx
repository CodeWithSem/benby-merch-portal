...
const Batch_Details = ({
  ...
  const handle_select_change =
    handle_select_change_function(set_edit_batch_data);
  const handle_text_change = handle_text_change_function(set_edit_batch_data);
  const handle_date_change = handle_date_change_function(set_edit_batch_data);
  const handle_checkbox_change =
    handle_checkbox_change_function(set_edit_batch_data);
  // RETURN ORIGIN
  return (
    <React.Fragment>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Date_Field
              ...
              value={edit_batch_data.manufacture_date} //--> manufacture_date
          ...
          <div>
            <Find_Field
              ...
              value={get_description(
                edit_batch_data.batch_type_code,
                batch_type_list,
                "batch_type_code",
                "batch_type_desc"
              )} //--> batch_type_code
          ...
          <div>
            <Date_Field
              label="SLED / BBD"
              placeholder="MM-DD-YYYY"
              value={edit_batch_data.sled_bbd} //--> sled_bbd
          ...
          <div>
            <Select_Field
              ...
              value={edit_batch_data.period_ind || ""} //--> period_ind
          ...
          <div className="col-span-full">
            <Textarea_Field
              ...
              height="100px"
              value={edit_batch_data.item_remarks} //--> item_remarks
          ...
          <div className="mt-4">
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={edit_batch_data.batch_delete_ind} //--> batch_delete_ind
