...
const Shipment = ({ new_po_data, set_new_po_data }) => {
  const handle_text_change = handle_text_change_function(set_new_po_data);
  const handle_date_change = handle_date_change_function(set_new_po_data);
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Date_Field
              ...
              value={new_po_data.sh_original_date} //--> sh_original_date
          ...
          <div>
            <Text_Field
              ...
              value={new_po_data.sh_container_size} //--> sh_container_size
          ...
          <div>
            <Text_Field
              ...
              value={new_po_data.sh_shipping_line} //--> sh_shipping_line
          ...
          <div>
            <Text_Field
              ...
              value={new_po_data.sh_container_no} //--> sh_shipping_line
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div className="col-span-full">
            <Text_Field
              ...
              value={new_po_data.sh_virtual_stopo} //--> sh_virtual_stopo
          ...
          <div className="col-span-full">
            <Text_Field
              ...
              value={new_po_data.sh_virtual_branch_group} //--> sh_virtual_branch_group
