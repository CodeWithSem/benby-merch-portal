...
const Select_Batch = ({
  ...
  const [batch_list, set_batch_list] = useState([
    ...
    },
    {
      id: 2,
      item_code: "ITM-000000001",
      batch_code: "00000001-B-002",
      batch_desc: "Batch Description 2",
    },
    {
      id: 3,
      item_code: "ITM-000000001",
      batch_code: "00000001-B-003",
      batch_desc: "Batch Description 3",
    },
  ]);
  ...
  useEffect(() => {
    if (for_posting && selected_batches_param.length > 0) {
      set_selected_batches(selected_batches_param);
    }
  }, [for_posting, selected_batches_param]);
      ...
      >
        ...
        >
          ...
          >
                                  ...
                                  <td className="px-5 py-4 text-gray-500 w-[80px]">
                                    <div className="flex justify-center items-center">
                                      <Checkbox_Field
                                        ...
                                        icon_size={12}
                                        checked={isChecked}
                                        disabled={for_posting} // ⬅️ disabled in posting mode
                                        on_change={() =>
                                          !for_posting &&
            ...
            {/* + Selected Batch List */}
            <div className={`w-full ${!for_posting && "md:col-span-3"}`}>
              <div className="overflow-hidden rounded-lg border border-gray-200 bg-white pt-4">
              ...
              <div className="w-full mt-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Text_Field
                    ...
                    int_only={true}
                    value={delivered_qty}
                    on_change={(e) => set_delivered_qty(e.target.value)}
                    disabled={for_posting}
                  />
                  <Text_Field
                    label="Batch Qty"
