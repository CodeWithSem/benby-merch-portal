        ...
        <div className="grid grid-cols-1 gap-5">
          <div>
            <Text_Code_Field
              ...
              code_value={edit_vendor_data.aci_company_code}
              text_value={get_description(
                edit_vendor_data.aci_company_code,
                company_list,
                "company_code",
                "company_desc"
              )} //--> aci_company_code
          ...
          <div>
            <Text_Code_Field
              ...
              code_value={edit_vendor_data.aci_purc_org_code}
              text_value={get_description(
                edit_vendor_data.aci_purc_org_code,
                purc_org_list,
                "purc_org_code",
                "purc_org_desc"
              )} //--> aci_purc_org_code
          ...
          <div>
            <Text_Code_Field
              ...
              code_width="150px"
              show_search_button={false}
              code_value={edit_vendor_data.aci_purc_group_code}
              text_value={get_description(
                edit_vendor_data.aci_purc_group_code,
                purc_group_list,
                "purc_group_code",
                "purc_group_desc"
              )} //--> aci_purc_group_code
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div>
            <Find_Field
              ...
              value={get_description(
                edit_vendor_data.aci_payment_method_code,
                payment_method_list,
                "payment_method_code",
                "payment_method_desc"
          ...
          <div>
            <Find_Field
              label="Payment Terms"
              value={get_description(
                edit_vendor_data.aci_payment_term_code,
                payment_term_list,
                "payment_term_code",
                "payment_term_desc"
          ...
          <div>
            <Find_Field
              label="Credit Terms"
              value={get_description(
                edit_vendor_data.aci_credit_term_code,
                payment_term_list,
                "payment_term_code",
                "payment_term_desc"
          ...
          <div>
            <Text_Field
              ...
              placeholder="0"
              int_only={true}
              value={edit_vendor_data.aci_credit_limit} //--> aci_credit_limit
          ...
          <div>
            <Find_Field
              label="Currency"
              value={edit_vendor_data.aci_currency} //--> aci_currency
          ...
          <div className="mt-4 col-span-full">
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={edit_vendor_data.aci_tax_liable} //--> aci_tax_liable
