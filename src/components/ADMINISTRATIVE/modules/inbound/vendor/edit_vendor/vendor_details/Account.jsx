...
const Account = ({
  ...
  const handle_checkbox_change =
    handle_checkbox_change_function(set_edit_vendor_data);
  // RETURN ORIGIN
  return (
    <React.Fragment>
      {/* + Section 1 */}
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div>
            <Text_Field
              ...
              value={edit_vendor_data.ac_tax_number} //--> ac_tax_number
          ...
          <div>
            <Find_Field
              ...
              value={get_description(
                edit_vendor_data.ac_taxation_code,
                taxation_list,
                "taxation_code",
                "taxation_desc"
              )} //--> ac_taxation_code
          ...
          <div>
            <Text_Field
              ...
              value={edit_vendor_data.ac_vat_reg_number} //--> ac_vat_reg_number
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div>
            <Find_Field
              label="Industry Type"
              value={get_description(
                edit_vendor_data.ac_industry_type_code,
                industry_type_list,
                "industry_type_code",
                "industry_type_desc"
          ...
          <div>
            <Find_Field
              label="Incoterms"
              value={get_description(
                edit_vendor_data.ac_incoterms_code,
                incoterms_list,
                "incoterms_code",
                "incoterms_desc"
              )} //--> ac_incoterms_code
          ...
          <div className="mt-4">
            <Checkbox_Field
              ...
              box_size={24}
              icon_size={14}
              checked={edit_vendor_data.ac_vendor_block} //--> ac_vendor_block
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div className="col-span-full">
            <Text_Field
              ...
              value={edit_vendor_data.ac_contact_name} //--> ac_contact_name
          ...
          <div>
            <Text_Field
              ...
              value={edit_vendor_data.ac_contact_telephone} //--> ac_contact_telephone
          ...
          <div>
            <Text_Field
              ...
              value={edit_vendor_data.ac_contact_fax} //--> ac_contact_fax
          ...
          <div>
            <Text_Field
              ...
              value={edit_vendor_data.ac_contact_mobile} //--> ac_contact_mobile
          ...
          <div>
            <Text_Field
              ...
              value={edit_vendor_data.ac_contact_position} //--> ac_contact_position
