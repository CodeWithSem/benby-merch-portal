...
const View_Vendor = ({ is_open, on_close, width = "max-w-[700px]" }) => {
    ...
    <React.Fragment>
      <div className="fixed inset-0 flex items-center justify-center z-[97] px-4">
        ...
        >
          ...
          {/* + Modal Label */}
          <div className="text-lg md:text-xl font-bold mb-5">View Vendor</div>
          {/* - Modal Label */}
          {/* + Modal Body */}
          <div className="w-full pl-1 p-4 overflow-y-auto h-[500px] scrollbar-custom">
            <div className="w-full bg-white rounded-lg border">
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <h1 className="text-lg">Vendor Information</h1>
              </div>
