...
const Delete_Vendor = ({ is_open, on_close, width = "max-w-[700px]" }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            ...
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to delete this Vendor.
            </p>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              This action is permanent and cannot be undone. All related data
              such as address, account, and accounting information will also be
    ...
    <React.Fragment>
      <div className="fixed inset-0 flex items-center justify-center z-[97] px-4">
        ...
        >
          ...
          {/* + Modal Label */}
          <div className="text-lg md:text-xl font-bold mb-5">Delete Vendor</div>
          {/* - Modal Label */}
          {/* + Modal Body */}
            ...
            <div className="w-full">
              <div className="w-full bg-white rounded-lg border">
                <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                  <h1 className="text-lg">Vendor Details</h1>
