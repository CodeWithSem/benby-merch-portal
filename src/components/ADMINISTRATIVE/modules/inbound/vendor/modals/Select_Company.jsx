                  ...
                  {filtered_da_com_porg_pgroup.length === 0 ? (
                    ...
                    filtered_da_com_porg_pgroup.map((data) => {
                      ...
                      const purc_org = purc_org_list.find(
                        (p) => p.purc_org_code === data.purc_org_code
                      );
                      const purc_group = purc_group_list.find(
                        (g) => g.purc_group_code === data.purc_group_code
                      );
                      return (
                        <tr
                          key={data.id}
                          className={`hover:bg-sky-50/50 cursor-pointer text-[12px] ${
                            selected_da_com_porg_pgroup?.id === data.id
                              ? "bg-sky-50"
                              : ""
                          }`}
                          onClick={() => set_selected_da_com_porg_pgroup(data)}
                        >
                          <td className="px-5 py-4 sm:px-6 text-center">
                            <div className="flex justify-center items-center">
                              <Checkbox_Field
                                ...
                                on_change={() =>
                                  set_selected_da_com_porg_pgroup(data)
                                }
                              />
                            </div>
                          </td>
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between gap-3 mt-5 px-7">
          ...
          <div className="flex justify-center sm:justify-end gap-2 w-full">
            <Button
              ...
              disabled={!selected_da_com_porg_pgroup}
            >
              Proceed
            </Button>
            <Button
