        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Text_Field
              ...
              value={new_vendor_data.ad_street} //--> ad_street
          ...
          <div>
            <Text_Field
              ...
              value={new_vendor_data.ad_postal_code} //--> ad_postal_code
          ...
          <div>
            <Text_Field
              ...
              type={"text"}
              value={get_description(
                new_vendor_data.ad_district_code,
                district_list,
                "district_code",
                "district_desc"
              )} //--> ad_city_code
          ...
          <div>
            <Text_Field
              ...
              type={"text"}
              value={get_description(
                new_vendor_data.ad_region_code,
                region_list,
                "region_code",
                "region_desc"
              )} //--> ad_region_code
          ...
          <div>
            <Text_Field
              ...
              type={"text"}
              value={get_description(
                new_vendor_data.ad_country_code,
                country_list,
                "country_code",
                "country_desc"
              )} //--> ad_country_code
          ...
          <div className="col-span-full">
            <Text_Code_Field
              ...
              code_value={new_vendor_data.ad_trans_zone_code}
              text_value={get_description(
                new_vendor_data.ad_trans_zone_code,
                trans_zone_list,
                "trans_zone_code",
                "trans_zone_desc"
              )} //--> ad_country_code
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Find_Field
              label="Language"
              value={get_description(
                new_vendor_data.ad_language_code,
                language_list,
                "language_code",
                "language_desc"
              )} //--> ad_language_code
          ...
          <div>
            <Text_Field
              ...
              value={new_vendor_data.ad_telephone} //--> ad_telephone
          ...
          <div>
            <Text_Field
              ...
              value={new_vendor_data.ad_fax} //--> ad_fax
          ...
          <div>
            <Text_Field
              ...
              value={new_vendor_data.ad_mobile} //--> ad_mobile
          ...
          <div className="col-span-full">
            <Text_Field
              ...
              value={new_vendor_data.ad_email} //--> ad_email
