...
// Import the EP specific API
import { push_execution_planner_to_cloud } from "api/real_time_db/cloud_management/execution_planner_api";

const Upload_EP = ({ set_page, on_success }) => {
  const { show_toast } = useToast();
  const [show_filter, set_show_filter] = useState(false);
  const [selected_id, set_selected_id] = useState(null);

  // Updated columns based on Execution Planner dataset
  const columns = [
    { key: "index", label: "NO.", sortable: false },
    { key: "id", label: "ID", sortable: true },
    { key: "storecode", label: "STORE CODE", sortable: true },
    { key: "tDSName", label: "TDS NAME", sortable: true },
    { key: "employeeID", label: "TDS CODE", sortable: true },
    { key: "chain", label: "CHAIN", sortable: true },
    { key: "brand", label: "BRAND", sortable: true },
    { key: "activity", label: "ACTIVITY", sortable: true },
    { key: "typeOfActivity", label: "TYPE", sortable: true },
    { key: "channel", label: "CHANNEL", sortable: true },
    { key: "region", label: "REGION", sortable: true },
    { key: "area", label: "AREA", sortable: true },
    { key: "city", label: "CITY", sortable: true },
    { key: "durationFrom", label: "START", sortable: true },
    { key: "durationTo", label: "END", sortable: true },
  ...
  const [upload_ep_list, set_upload_ep_list] = useState([]);
  ...
  const handle_fetch_data = async () => {
    ...
    try {
      const response = await axios.get(
        "https://benbyextportal.com/home/api/get/GetEP?Storecode=0&TDScode=0",
        {
      ...
      if (response.data) {
        ...
        set_upload_ep_list(formatted_data);
        show_toast({
          type: "success",
          title: "Data Fetched",
          message: "The Execution Planner payload is ready.",
      ...
      if (axios.isCancel(error)) {
        ...
        show_toast({
          type: "danger",
          title: "Error",
          message: "Failed to fetch EP data. Please try again.",
  ...
  const handle_upload = async () => {
    ...
    try {
      const result = await push_execution_planner_to_cloud(
        upload_ep_list,
      ...
      show_toast({
        type: "success",
        title: "Data Uploaded",
        message: "Execution Planner has been pushed to the cloud.",
        icon: <CheckCircle2 size={21} className="text-green-500" />,
      });
  ...
  const {
    ...
    filtered_data,
    total_pages,
  } = client_side_filter(upload_ep_list, columns);
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Upload Execution Planner</h1>
            </div>
          ...
          {/* + SECTION 2: Table Controls and Content */}
          <div className="p-5 sm:p-6 border-t">
          ...
          <div className="p-5 sm:p-6 border-t">
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
              <Button
                ...
                disabled={upload_ep_list.length === 0 || is_fetching}
              >
                Upload to Cloud
              </Button>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 animate-in fade-in zoom-in duration-200">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-slate-500 mb-6">
                Retrieving records from Benby Portal...
              </p>
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[10000] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-slate-500 mb-6">
                Syncing Execution Planner with Firebase...
              </p>
