...
const SO_Items = () => {
  ...
  const all_columns = [
    ...
    { key: "discount_type", label: "Discount Type", visible: true },
    { key: "discount", label: "Discount", visible: true },
    { key: "net_price", label: "Net Price", visible: true },
    { key: "total_gross", label: "Total Gross", visible: true },
    { key: "total_net", label: "Total Net", visible: true },
    { key: "currency", label: "Currency", visible: true },
    { key: "pricing_date", label: "Pricing Date", visible: true },
    { key: "on_hand", label: "On Hand", visible: true },
    { key: "committed", label: "Committed", visible: true },
    { key: "is_approved", label: "Is Approved", visible: true },
