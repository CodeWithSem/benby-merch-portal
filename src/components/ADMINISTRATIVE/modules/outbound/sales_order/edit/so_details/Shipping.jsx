  ...
  return (
    <React.Fragment>
        ...
        <div className="grid grid-cols-1 gap-5">
          <div>
            <Text_Code_Field
              ...
              code_value={edit_so_data.plant_code}
              text_value={get_description(
                edit_so_data.plant_code,
                plant_list,
                "plant_code",
                "plant_desc",
              )}
          ...
          <div>
            <Text_Code_Field
              label="Warehouse"
              code_width="150px"
              show_search_button={!!edit_so_data.plant_code}
              code_value={edit_so_data.warehouse_code}
              text_value={get_description(
                edit_so_data.warehouse_code,
                warehouse_list,
                "warehouse_code",
                "warehouse_desc",
              )}
          ...
          <div>
            <Text_Code_Field
              label="SLOC"
              code_width="150px"
              show_search_button={!!edit_so_data.warehouse_code}
              code_value={edit_so_data.sloc_code}
              text_value={get_description(
                edit_so_data.sloc_code,
                sloc_list,
                "sloc_code",
                "sloc_desc",
              )}
      ...
      <Select_Warehouse
        ...
        width="max-w-[1000px]"
        height="max-h-[700px]"
        selected_plant_code={edit_so_data.plant_code}
        plant_list={plant_list}
      ...
      <Select_SLOC
        ...
        width="max-w-[1000px]"
        height="max-h-[700px]"
        selected_warehouse_code={edit_so_data.warehouse_code}
        warehouse_list={warehouse_list}
        sloc_list={sloc_list}
