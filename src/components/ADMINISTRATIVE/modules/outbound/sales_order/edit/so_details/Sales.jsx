...
const Sales = ({ so_data }) => {
  const { order_reason_list, edit_so_data, set_edit_so_data } = so_data;
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div>
            <Date_Field
              ...
              value={edit_so_data?.sa_required_deliv_date}
          ...
          <div className="ml-0 lg:ml-7 flex items-end gap-10 pb-[7px]">
            <div>
              <Checkbox_Field
                ...
                box_size={24}
                icon_size={14}
                checked={edit_so_data?.sa_blocked_delivery}
            ...
            <div>
              <Checkbox_Field
                ...
                box_size={24}
                icon_size={14}
                checked={edit_so_data?.sa_blocked_billing}
          ...
          <div>
            <Find_Field
              ...
              value={get_description(
                edit_so_data?.sa_order_reason_code,
                order_reason_list,
                "order_reason_code",
                "order_reason_desc",
              )}
