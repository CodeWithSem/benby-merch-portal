...
const Remove_Order = ({ is_open, on_close, width = "max-w-[700px]" }) => {
  const handle_remove_order = () => {
    alert("Remove Order");
  };
    ...
    <React.Fragment>
      <div className="fixed inset-0 flex items-center justify-center z-[97] px-4">
        ...
        >
          ...
          {/* + Modal Label */}
          <div className="text-lg md:text-xl font-bold mb-5">Remove Order</div>
          {/* - Modal Label */}
          {/* + Modal Body */}
