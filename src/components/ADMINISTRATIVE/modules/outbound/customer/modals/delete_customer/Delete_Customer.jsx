...
const Delete_Customer = ({ is_open, on_close, width = "max-w-[700px]" }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            ...
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              ...
              such as including address, account, sales and partner will also be
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                width="w-[100px]"
                variant="danger"
                on_click={handle_delete_customer}
              >
                Yes
              </Button>
              <Button
