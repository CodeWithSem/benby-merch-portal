...
const Truck = () => {
  ...
  const columns = [
    ...
    { key: "plate_no", label: "Plate Number", sortable: true },
    { key: "truck_type", label: "Truck Type", sortable: true },
    { key: "creation_date", label: "Creation Date", sortable: true },
    { key: "actions", label: "", sortable: false },
  ];

  const [truck_list, set_truck_list] = useState([
    {
      id: 1,
      plate_no: "ABC-123",
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : truck_list.length) / select_option
  );
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_truck}
                  >
                    Create New Truck
                  </Button>
                  <Button
