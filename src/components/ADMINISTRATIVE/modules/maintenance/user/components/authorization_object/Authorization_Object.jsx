// File Name: Authorization_Object
// Function Name: Auth_Object
// Data Name: auth_object
// Column Name: Authorization Object
// Title Name: Authorization Object
// Sub-module Name: User
// Table Name: TBL_AUTHORIZATION_OBJECT
...
import Create_Auth_Object from "./functions/Create_Auth_Object";
...
const Authorization_Object = ({ set_page }) => {
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_AUTHORIZATION_OBJECT", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
      }));
  ...
  const columns = [
    ...
    {
      key: "auth_object_code",
      label: "Authorization Object Code",
      sortable: true,
    },
    {
      key: "auth_object_desc",
      label: "Authorization Object Description",
      sortable: true,
    },
  ...
  const [auth_object_list, set_auth_object_list] = useState([]);

  const handle_get_auth_object_list = async () => {
    set_loading_list(true);
    const response = await api_get_auth_object_list();
    if (response.success) {
      set_auth_object_list(response.data);
    } else {
  ...
  const handle_truncate_auth_object_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_auth_object();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_auth_object_list, set_filtered_auth_object_list] = useState(
    []
  );
  ...
  useEffect(() => {
    ...
    set_filtered_auth_object_list(indexed_data);
  }, [
    auth_object_list,
    debounced_query,
    sort_by,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : auth_object_list.length) / select_option
  );
  ...
  const handle_create_new_auth_object = () => {
    set_sub_page("create_new_auth_object");
  };

  const handle_edit_auth_object = (data) => {
    set_edit_data(data);
    set_sub_page("edit_auth_object");
  };
  const handle_delete_auth_object = (data) => {
    set_delete_data(data);
    set_display_modal("delete_auth_object");
  };

  const handle_upload_auth_object = () => {
    set_sub_page("upload_auth_object");
  };
  ...
  return (
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Authorization Object</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
                ...
                <div className="flex gap-2">
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_auth_object_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_auth_object}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_auth_object}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_auth_object_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_auth_object_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_auth_object_list.map((row, idx) => {
                            // + Cell Renderer
      ...
      {sub_page === "create_new_auth_object" && (
        <Create_Auth_Object
      ...
      {sub_page === "upload_auth_object" && (
        <Upload_Auth_Object
          handle_go_back={handle_go_back}
          handle_get_auth_object_list={handle_get_auth_object_list}
          show_toast={show_toast}
        />
      )}
      <Delete_Auth_Object
        is_open={display_modal === "delete_auth_object"}
...
export default Authorization_Object;
