// File Name: User_Category
// Function Name: User_Category
// Data Name: user_category
// Column Name: User Category
// Title Name: User Category
...
import Create_User_Category from "./functions/Create_User_Category";
...
const User_Category = ({ set_page }) => {
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_USER_CATEGORY", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
      }));
  ...
  const columns = [
    ...
    { key: "user_category_code", label: "User Category Code", sortable: true },
    {
      key: "user_category_desc",
  ...
  const [user_category_list, set_user_category_list] = useState([]);

  const handle_get_user_category_list = async () => {
    set_loading_list(true);
    const response = await api_get_user_category_list();
    if (response.success) {
      set_user_category_list(response.data);
    } else {
  ...
  const handle_truncate_user_category_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_user_category();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_user_category_list, set_filtered_user_category_list] =
    useState([]);
  ...
  useEffect(() => {
    ...
    set_filtered_user_category_list(indexed_data);
  }, [
    user_category_list,
    debounced_query,
    sort_by,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : user_category_list.length) / select_option
  );
  ...
  const handle_create_new_user_category = () => {
    set_sub_page("create_new_user_category");
  };

  const handle_edit_user_category = (data) => {
    set_edit_data(data);
    set_sub_page("edit_user_category");
  };
  const handle_delete_user_category = (data) => {
    set_delete_data(data);
    set_display_modal("delete_user_category");
  };

  const handle_upload_user_category = () => {
    set_sub_page("upload_user_category");
  };
  ...
  return (
    <React.Fragment>
                ...
                <div className="flex gap-2">
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_user_category_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_user_category}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_user_category}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_user_category_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_user_category_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_user_category_list.map((row, idx) => {
                            // + Cell Renderer
                                  ...
                                  <div className="flex gap-2">
                                    ...
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() =>
                                          handle_delete_user_category(row)
                                        }
                                      >
                                        <Trash size={19} />
                                      </button>
      ...
      {sub_page === "create_new_user_category" && (
      ...
      {sub_page === "upload_user_category" && (
        <Upload_User_Category
          handle_go_back={handle_go_back}
          handle_get_user_category_list={handle_get_user_category_list}
          show_toast={show_toast}
        />
      )}
      <Delete_User_Category
        is_open={display_modal === "delete_user_category"}
