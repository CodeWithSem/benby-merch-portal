...
import { api_update_user_role } from "api/firestore_db/maintenance/user/tbl_user_role_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Edit_User_Role = ({
  ...
  const validate_edit_data = () => {
    ...
    if (!edit_data.user_role_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_update_user_role = async () => {
    ...
    try {
      ...
      const response = await api_update_user_role(
        edit_data,
        active_user?.username
      );
      if (response.success) {
        console_log(response.data);
        set_user_role_list((prev) =>
          prev.map((item) =>
      ...
      console.error("Failed to create user_role:", error);
      show_status("error");
    } finally {
      close_confirm_modal();
    }
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            ...
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this User Role. Once edited, it will be
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_user_role}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit User Role</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-x 0 lg:gap-x-5 gap-y-5 lg:grid-cols-3">
              <div>
                <Text_Field
                  ...
                  type={"text"}
                  value={edit_data.user_role_code || "-"}
                  disabled
                />
              </div>
              <div className="col-span-2">
                <Text_Field
                  ...
                  value={edit_data.user_role_desc}
                  on_change={(e) =>
