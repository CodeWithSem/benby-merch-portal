...
import { api_update_shipment_route } from "api/firestore_db/maintenance/shipment/tbl_shipment_route_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Edit_Shipment_Route = ({
  ...
  const validate_edit_data = () => {
    if (!edit_data.shipment_route_code.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
    ...
    if (!edit_data.shipment_route_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_update_shipment_route = async () => {
    ...
    try {
      ...
      const response = await api_update_shipment_route(
        edit_data,
      ...
      console.error("Failed to create shipment_route:", error);
    } finally {
      close_confirm_modal();
    }
  };
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Shipment Route Update
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Shipment Route. Once edited, it will be
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_shipment_route}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Shipment Route</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-x 0 lg:gap-x-5 gap-y-5 lg:grid-cols-3">
              <div>
                <Text_Field
                  ...
                  type={"text"}
                  value={edit_data.shipment_route_code || "-"}
                  disabled
                />
              </div>
              <div className="col-span-2">
                <Text_Field
                  ...
                  value={edit_data.shipment_route_desc}
                  on_change={(e) =>
...
export default Edit_Shipment_Route;
