...
import Shipment_Type from "./components/shipment_type/Shipment_Type";
import Shipment_Route from "./components/shipment_route/Shipment_Route";
import Trans_Mode_Type from "./components/trans_mode_type/Trans_Mode_Type";

const Shipment_Maint = () => {
  const [page, set_page] = useState("main");
  const [search_query, set_search_query] = useState("");

  const structure_list = [
    { key: "shipment_type", icon: Truck, title: "Shipment Type" },
    { key: "shipment_route", icon: Truck, title: "Shipment Route" },
    { key: "trans_mode_type", icon: Truck, title: "Transportation Mode Type" },
  ];
  ...
  return (
    <React.Fragment>
      ...
      {/* + Pages */}
      {page === "shipment_type" && <Shipment_Type set_page={set_page} />}
      {page === "shipment_route" && <Shipment_Route set_page={set_page} />}
      {page === "trans_mode_type" && <Trans_Mode_Type set_page={set_page} />}
      {/* - Pages */}
    </React.Fragment>
  );
};

export default Shipment_Maint;
