...
import { api_update_employee } from "api/firestore_db/maintenance/personnel/tbl_employee_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Edit_Employee = ({
  ...
  const validate_edit_data = () => {
    if (!edit_data.employee_code.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
    ...
    if (!edit_data.employee_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_update_employee = async () => {
    ...
    try {
      ...
      const response = await api_update_employee(
        edit_data,
        active_user?.username
      );
      if (response.success) {
        console_log(response.data);
        set_employee_list((prev) =>
          prev.map((item) =>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            ...
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Employee. Once edited, it will be
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_employee}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Employee</h1>
            </div>
