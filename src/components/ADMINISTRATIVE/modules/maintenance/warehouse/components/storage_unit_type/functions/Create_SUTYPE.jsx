...
import { api_create_sutype } from "api/firestore_db/maintenance/warehouse/tbl_sutype_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Create_SUTYPE = ({
  ...
  const handle_create_sutype = async () => {
    ...
    try {
      ...
      const response = await api_create_sutype(new_data, active_user?.username);
      if (response.success) {
        console_log(response.data);
        set_sutype_list((prev) => [...prev, response.data]);
        show_status("success");
        reset_new_data();
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Storage Unit Type Creation
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to create a new Storage Unit Type. Once created, it
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Storage Unit Type Creation</h1>
            </div>
