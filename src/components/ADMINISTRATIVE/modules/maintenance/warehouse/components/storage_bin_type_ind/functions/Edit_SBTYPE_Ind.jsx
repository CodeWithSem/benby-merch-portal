...
import { api_update_sbtype_ind } from "api/firestore_db/maintenance/warehouse/tbl_sbtype_ind_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Edit_SBTYPE_Ind = ({
  ...
  const validate_edit_data = () => {
    if (!edit_data.sbtype_ind_code.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
    ...
    if (!edit_data.sbtype_ind_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_update_sbtype_ind = async () => {
    ...
    try {
      ...
      const response = await api_update_sbtype_ind(
        edit_data,
      ...
      console.error("Failed to create sbtype_ind:", error);
    } finally {
      close_confirm_modal();
    }
  };
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Storage Bin Type Indicator Update
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Storage Bin Type Indicator. Once
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_sbtype_ind}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Storage Bin Type Indicator</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-x 0 lg:gap-x-5 gap-y-5 lg:grid-cols-3">
              <div>
                <Text_Field
                  ...
                  type={"text"}
                  value={edit_data.sbtype_ind_code || "-"}
                  disabled
                />
              </div>
              <div className="col-span-2">
                <Text_Field
                  ...
                  value={edit_data.sbtype_ind_desc}
                  on_change={(e) =>
...
export default Edit_SBTYPE_Ind;
