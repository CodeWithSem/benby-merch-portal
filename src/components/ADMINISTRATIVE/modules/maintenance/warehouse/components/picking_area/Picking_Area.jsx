// File Name: Picking_Area
// Function Name: Picking_Area
// Data Name: pick_area
// Column Name: Picking Area
// Title Name: Picking Area
// Sub-module Name: Warehouse
// Table Name: TBL_PICKING_AREA
// Default Code: PA
...
import Create_Picking_Area from "./functions/Create_Picking_Area";
...
const Picking_Area = ({ set_page }) => {
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_PICKING_AREA", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
  ...
  const columns = [
    ...
    { key: "pick_area_code", label: "Picking Area Code", sortable: true },
    {
      key: "pick_area_desc",
      label: "Picking Area Description",
      sortable: true,
    },
  ...
  const [pick_area_list, set_pick_area_list] = useState([]);

  const handle_get_pick_area_list = async () => {
    set_loading_list(true);
    const response = await api_get_pick_area_list();
    if (response.success) {
      set_pick_area_list(response.data);
    } else {
  ...
  const handle_truncate_pick_area_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_pick_area();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_pick_area_list, set_filtered_pick_area_list] = useState([]);
  ...
  useEffect(() => {
    ...
    set_filtered_pick_area_list(indexed_data);
  }, [
    pick_area_list,
    debounced_query,
    sort_by,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : pick_area_list.length) / select_option
  );
  ...
  const handle_create_new_pick_area = () => {
    set_sub_page("create_new_pick_area");
  };

  const handle_edit_pick_area = (data) => {
    set_edit_data(data);
    set_sub_page("edit_pick_area");
  };
  const handle_delete_pick_area = (data) => {
    set_delete_data(data);
    set_display_modal("delete_pick_area");
  };

  const handle_upload_pick_area = () => {
    set_sub_page("upload_pick_area");
  };
  ...
  return (
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Picking Area</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
                ...
                <div className="flex gap-2">
                  ...
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_pick_area_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_pick_area}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_pick_area}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_pick_area_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_pick_area_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_pick_area_list.map((row, idx) => {
                            // + Cell Renderer
      ...
      {sub_page === "upload_pick_area" && (
        <Upload_Picking_Area
          handle_go_back={handle_go_back}
          handle_get_pick_area_list={handle_get_pick_area_list}
          show_toast={show_toast}
        />
      )}
      <Delete_Picking_Area
        is_open={display_modal === "delete_pick_area"}
