...
import { api_update_warehouse } from "api/firestore_db/maintenance/warehouse/tbl_warehouse_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Edit_Warehouse = ({
  ...
  const validate_edit_data = () => {
    ...
    if (!edit_data.warehouse_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_update_warehouse = async () => {
    ...
    try {
      ...
      const response = await api_update_warehouse(
        edit_data,
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            ...
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Warehouse. Once edited, it will be
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_warehouse}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Warehouse</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-x 0 lg:gap-x-5 gap-y-5 lg:grid-cols-3">
              <div>
                <Text_Field
                  ...
                  type={"text"}
                  value={edit_data.warehouse_code || "-"}
                  disabled
                />
              </div>
              <div className="col-span-2">
                <Text_Field
                  ...
                  value={edit_data.warehouse_desc}
                  on_change={(e) =>
