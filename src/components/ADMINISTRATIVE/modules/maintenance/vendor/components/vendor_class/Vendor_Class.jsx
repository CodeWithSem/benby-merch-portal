// File Name: Vendor_Class
// Function Name: Vendor_Class
// Data Name: vendor_class
// Column Name: Vendor Class
// Title Name: Vendor Class
// Sub-module Name: Vendor
// Table Name: TBL_VENDOR_CLASS
// Default Code: V-CL
...
import Create_Vendor_Class from "./functions/Create_Vendor_Class";
...
const Vendor_Class = ({ set_page }) => {
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_VENDOR_CLASS", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
  ...
  const columns = [
    ...
    { key: "vendor_class_code", label: "Vendor Class Code", sortable: true },
    {
      key: "vendor_class_desc",
  ...
  const [vendor_class_list, set_vendor_class_list] = useState([]);

  const handle_get_vendor_class_list = async () => {
    set_loading_list(true);
    const response = await api_get_vendor_class_list();
    if (response.success) {
      set_vendor_class_list(response.data);
    } else {
  ...
  const handle_truncate_vendor_class_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_vendor_class();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_vendor_class_list, set_filtered_vendor_class_list] = useState(
    []
  );
  ...
  useEffect(() => {
    ...
    set_filtered_vendor_class_list(indexed_data);
  }, [
    vendor_class_list,
    debounced_query,
    sort_by,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : vendor_class_list.length) / select_option
  );
  ...
  const handle_create_new_vendor_class = () => {
    set_sub_page("create_new_vendor_class");
  };

  const handle_edit_vendor_class = (data) => {
    set_edit_data(data);
    set_sub_page("edit_vendor_class");
  };
  const handle_delete_vendor_class = (data) => {
    set_delete_data(data);
    set_display_modal("delete_vendor_class");
  };

  const handle_upload_vendor_class = () => {
    set_sub_page("upload_vendor_class");
  };
  ...
  return (
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Vendor Class</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
                ...
                <div className="flex gap-2">
                  ...
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_vendor_class_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_vendor_class}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_vendor_class}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_vendor_class_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_vendor_class_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_vendor_class_list.map((row, idx) => {
                            // + Cell Renderer
                                  ...
                                  <div className="flex gap-2">
                                    ...
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() =>
                                          handle_delete_vendor_class(row)
                                        }
                                      >
                                        <Trash size={19} />
                                      </button>
      ...
      {sub_page === "create_new_vendor_class" && (
        <Create_Vendor_Class
      ...
      {sub_page === "upload_vendor_class" && (
        <Upload_Vendor_Class
          handle_go_back={handle_go_back}
          handle_get_vendor_class_list={handle_get_vendor_class_list}
          show_toast={show_toast}
        />
      )}
      <Delete_Vendor_Class
        is_open={display_modal === "delete_vendor_class"}
