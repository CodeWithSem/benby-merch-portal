...
import Create_Vendor from "./functions/Create_Vendor";
import Edit_Vendor from "./functions/Edit_Vendor";
import Delete_Vendor from "./functions/Delete_Vendor";

const Vendor = ({ set_page }) => {
  // + Variables
  ...
  const handle_create_new_vendor = () => {
    set_sub_page("create_new_vendor");
  };

  const handle_edit_vendor = (data) => {
    set_edit_data(data);
    set_sub_page("edit_vendor");
  };
  const handle_delete_vendor = (data) => {
  ...
  return (
    <React.Fragment>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_vendor(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
                                    ...
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        className="text-gray-500 hover:text-sky-600 text-[12px] outline-none"
                                        onClick={() => handle_edit_vendor(row)}
                                      >
                                        <Edit size={19} />
                                      </button>
                                      <span className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 px-2 py-1 text-xs text-white bg-sky-600 rounded opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      {sub_page === "create_new_vendor" && (
        <Create_Vendor handle_go_back={handle_go_back} />
      )}
      {sub_page === "edit_vendor" && (
        <Edit_Vendor
