...
import Create_Incoterms from "./functions/Create_Incoterms";
import Edit_Incoterms from "./functions/Edit_Incoterms";
import Delete_Incoterms from "./functions/Delete_Incoterms";
import Spinner from "assets/elements/Spinner";
import Upload_Incoterms from "./functions/Upload_Incoterms";
import Text_Field from "assets/elements/Text_Field";
import Set_Increment_ID from "assets/elements/modals/Set_Increment_ID";

const HAS_FILTER = true;

const Incoterms = ({ set_page }) => {
  ...
  const [new_data, set_new_data] = useState({ ...def_incoterms_data });
  const [edit_data, set_edit_data] = useState({ ...def_incoterms_data });
  const [delete_data, set_delete_data] = useState({ ...def_incoterms_data });
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_INCOTERMS", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
        incoterms_code: `ITR-${String(value).padStart(2, "0")}`,
      }));
  ...
  const columns = [
    ...
    { key: "incoterms_code", label: "Incoterms Code", sortable: true },
    { key: "incoterms_desc", label: "Incoterms Description", sortable: true },
  ...
  const [incoterms_list, set_incoterms_list] = useState([]);
  // ======================================================
  //   id: 1,
  //   incoterms_code: "COM-001",
  //   incoterms_desc: "Incoterms Description 1",
  //   created_by: "Admin",
  ...
  const handle_get_incoterms_list = async () => {
    set_loading_list(true);
    const response = await api_get_incoterms_list();
    if (response.success) {
      set_incoterms_list(response.data);
    } else {
  ...
  useEffect(() => {
    handle_get_incoterms_list();
  }, []);

  const handle_truncate_incoterms_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_incoterms();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_incoterms_list, set_filtered_incoterms_list] = useState([]);
  ...
  useEffect(() => {
    ...
    set_filtered_incoterms_list(indexed_data);
  }, [
    incoterms_list,
    debounced_query,
    sort_by,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : incoterms_list.length) / select_option
  );
  ...
  const handle_create_new_incoterms = () => {
    set_sub_page("create_new_incoterms");
  };

  const handle_edit_incoterms = (data) => {
    set_edit_data(data);
    set_sub_page("edit_incoterms");
  };
  const handle_delete_incoterms = (data) => {
    set_delete_data(data);
    set_display_modal("delete_incoterms");
  };

  const handle_upload_incoterms = () => {
    set_sub_page("upload_incoterms");
  };
    ...
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Incoterms</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
            ...
            <div className="w-full bg-white rounded-lg border">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h1 className="text-lg">Incoterms</h1>
                </div>
                <div className="flex gap-2">
                  ...
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_incoterms_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_incoterms}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_incoterms}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_incoterms_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_incoterms_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_incoterms_list.map((row, idx) => {
                            // + Cell Renderer
      ...
      {sub_page === "create_new_incoterms" && (
        <Create_Incoterms
          ...
          set_incoterms_list={set_incoterms_list}
        />
      )}
      {sub_page === "edit_incoterms" && (
        <Edit_Incoterms
          handle_go_back={handle_go_back}
          active_user={active_user}
          show_toast={show_toast}
      ...
      {sub_page === "upload_incoterms" && (
        <Upload_Incoterms
          handle_go_back={handle_go_back}
          handle_get_incoterms_list={handle_get_incoterms_list}
          show_toast={show_toast}
        />
      )}
      <Delete_Incoterms
        is_open={display_modal === "delete_incoterms"}
      ...
      <Set_Increment_ID
        ...
        api_set_increment_id={api_set_incoterms_increment}
      />
    </React.Fragment>
  );
};
