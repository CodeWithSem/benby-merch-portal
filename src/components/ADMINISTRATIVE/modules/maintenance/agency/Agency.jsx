...
import Upload_Store from "./upload/Upload_Agency";
import {
  get_all_agency,
  truncate_agency,
} from "api/real_time_db/maintenance/agency_api";
...
const Agency = () => {
  ...
  const [agency_list, set_agency_list] = useState([]);

  const handle_get_agency_list = async () => {
    try {
      set_loading(true);
      const response = await get_all_agency();
      set_agency_list(response);
      set_current_page(1);
    } catch (error) {
  ...
  const {
    ...
    filtered_data,
    total_pages,
  } = client_side_filter(agency_list, columns);
  ...
  const handle_truncate = async () => {
    try {
      ...
      const result = await truncate_agency((progress) => {
  ...
  return (
    <React.Fragment>
          ...
          <div className="w-full">
            ...
            <div className="w-full bg-white rounded-lg border">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <h1 className="text-lg">Agency</h1>
                  ...
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_agency_list}
                      />
                    </div>
      ...
      {/* + PAGES */}
      {page === "upload_mcp" && (
        <Upload_Store set_page={set_page} on_upload={handle_get_agency_list} />
      )}
      {/* - PAGES */}
      {/* + MODALS */}
      <Truncate_Modal
      ...
      <Confirm_Modal
        ...
        description_1="Are you sure you want to delete all Agency data?"
