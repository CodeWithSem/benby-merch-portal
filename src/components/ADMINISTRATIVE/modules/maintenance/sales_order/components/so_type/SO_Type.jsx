// File Name: SO_Type
// Function Name: SO_Type
// Data Name: so_type
// Column Name: Sales Order Type
// Title Name: Sales Order Type
// Sub-module Name: Sales Order
// Table Name: TBL_SALES_ORDER_TYPE
...
import {
  ...
  api_set_so_type_increment,
  api_truncate_so_type,
} from "api/firestore_db/maintenance/sales_order/tbl_so_type_api";
...
import Create_SO_Type from "./functions/Create_SO_Type";
import Edit_SO_Type from "./functions/Edit_SO_Type";
import Delete_SO_Type from "./functions/Delete_SO_Type";
import Upload_SO_Type from "./functions/Upload_SO_Type";
import Set_Increment_ID from "assets/elements/modals/Set_Increment_ID";

const HAS_FILTER = true;

const SO_Type = ({ set_page }) => {
  ...
  const [new_data, set_new_data] = useState({ ...def_so_type_data });
  const [edit_data, set_edit_data] = useState({ ...def_so_type_data });
  const [delete_data, set_delete_data] = useState({ ...def_so_type_data });
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_SALES_ORDER_TYPE", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
      }));
  ...
  const columns = [
    ...
    { key: "so_type_code", label: "Sales Order Type Code", sortable: true },
    {
      key: "so_type_desc",
      label: "Sales Order Type Description",
      sortable: true,
    },
  ...
  const handle_get_so_type_list = async () => {
    set_loading_list(true);
    const response = await api_get_so_type_list();
    if (response.success) {
      set_so_type_list(response.data);
    } else {
  ...
  useEffect(() => {
    handle_get_so_type_list();
  }, []);

  const handle_truncate_so_type_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_so_type();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  useEffect(() => {
    ...
    set_filtered_so_type_list(indexed_data);
  }, [
    so_type_list,
    debounced_query,
    sort_by,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : so_type_list.length) / select_option
  );
  ...
  const handle_create_new_so_type = () => {
    set_sub_page("create_new_so_type");
  };

  const handle_edit_so_type = (data) => {
    set_edit_data(data);
    set_sub_page("edit_so_type");
  };
  const handle_delete_so_type = (data) => {
    set_delete_data(data);
    set_display_modal("delete_so_type");
  };

  const handle_upload_so_type = () => {
    set_sub_page("upload_so_type");
  };
    ...
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Sales Order Type</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
            ...
            <div className="w-full bg-white rounded-lg border">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <div className="flex items-center gap-3">
                  ...
                  ></Button>
                  <h1 className="text-lg">Sales Order Type</h1>
                </div>
                <div className="flex gap-2">
                  ...
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_so_type_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_so_type}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_so_type}
                  >
                    Upload
                  </Button>
                </div>
                  ...
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_so_type_list}
                      ></Button>
                    </div>
                    ...
                    {loading_list ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_so_type_list.map((row, idx) => {
                            // + Cell Renderer
                                  ...
                                  <div className="flex gap-2">
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() => handle_edit_so_type(row)}
                                      >
                                        <Edit size={19} />
                                      </button>
      ...
      {sub_page === "create_new_so_type" && (
        <Create_SO_Type
          ...
          set_so_type_list={set_so_type_list}
        />
      )}
      {sub_page === "edit_so_type" && (
        <Edit_SO_Type
          handle_go_back={handle_go_back}
          active_user={active_user}
          show_toast={show_toast}
      ...
      {sub_page === "upload_so_type" && (
        <Upload_SO_Type
          handle_go_back={handle_go_back}
          handle_get_so_type_list={handle_get_so_type_list}
          show_toast={show_toast}
        />
      )}
      <Delete_SO_Type
        is_open={display_modal === "delete_so_type"}
      ...
      <Set_Increment_ID
        ...
        api_set_increment_id={api_set_so_type_increment}
      />
    </React.Fragment>
  );
};

export default SO_Type;
