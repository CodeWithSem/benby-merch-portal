...
const Upload_Company_H = ({
  ...
  const columns = [
    ...
    { key: "purc_org_code", label: "Purhcasing Organization", sortable: true },
    { key: "purc_group_code", label: "Purhcasing Group", sortable: true },
  ...
  const [upload_company_hierarchy_list, set_upload_company_hierarchy_list] =
    useState([]);

  // + Client-Side Filtering
  const [
    filtered_upload_company_hierarchy_list,
    set_filtered_upload_company_hierarchy_list,
  ] = useState([]);
  ...
  useEffect(() => {
    let temp = [...upload_company_hierarchy_list];
    ...
    set_filtered_upload_company_hierarchy_list(indexed_data);
  }, [
    upload_company_hierarchy_list,
    debounced_query,
    sort_by,
    sort_order,
    current_page,
  ...
  const total_pages = Math.ceil(
    ...
    (debounced_query
      ? upload_company_hierarchy_list.filter((u) => {
          const q = debounced_query.toLowerCase();
      ...
      : upload_company_hierarchy_list.length) / // <-- Use full list length if no query
  ...
  const handle_excel_upload = (e) => {
    handle_excel_upload_3_hierarchy({
      e,
      code_field_1: "company_code",
      code_field_2: "purc_org_code",
      code_field_3: "purc_group_code",
      set_data_callback: set_upload_company_hierarchy_list,
      show_toast,
    });
  };

  const handle_upload_company_hierarchy = async () => {
    if (upload_company_hierarchy_list.length === 0) {
      show_toast({
        type: "danger",
        title: "Invalid Data",
    ...
    try {
      const response = await api_bulk_upload_company_hierarchy(
        upload_company_hierarchy_list
      );
      ...
      if (response.success) {
        show_toast({
          ...
          message: `${upload_company_hierarchy_list.length} data has been uploaded.`,
          icon: <CheckCircle2 size={21} className="text-green-500" />,
        });
        set_upload_company_hierarchy_list([]);
        handle_get_company_hierarchy_list();
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Upload Company Hierarchy</h1>
            </div>
          ...
          <div className="p-5 sm:p-6 border-t">
            <div className="w-full border rounded-lg">
              ...
              <div className="overflow-x-auto">
                {filtered_upload_company_hierarchy_list.length === 0 ? (
                  ...
                  <table className="min-w-full">
                    ...
                    <tbody className="bg-white">
                      {filtered_upload_company_hierarchy_list.map(
                        (row, idx) => {
...
export default Upload_Company_H;
