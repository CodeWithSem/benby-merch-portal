...
import { api_delete_branch_hierarchy } from "api/firestore_db/maintenance/data_assignment/tbl_branch_hierarchy_api";
...
const Delete_Branch_H = ({
  ...
  const handle_delete_branch_hierarchy = async (id) => {
    try {
      set_delete_loading(true);

      const response = await api_delete_branch_hierarchy(id);

      if (response.success) {
        set_branch_hierarchy_list((prev) =>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Delete Branch Hierarchy
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to delete this Branch Hierarchy.
            </p>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={() => handle_delete_branch_hierarchy(delete_data.id)}
              >
                Yes
              </Button>
              <Button
            ...
            <div className="w-full">
              <div className="w-full bg-white rounded-lg border">
                <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                  <h1 className="text-lg">Branch Hierarchy Details</h1>
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    <div>
                      <Text_Code_Field
                        ...
                        code_value={delete_data.branch_code}
                        text_value={get_description(
                          delete_data.branch_code,
                          branch_list,
                          "branch_code",
                          "branch_desc"
                        )}
...
export default Delete_Branch_H;
