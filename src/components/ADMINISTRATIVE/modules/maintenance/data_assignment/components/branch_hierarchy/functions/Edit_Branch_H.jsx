...
const Edit_Branch_H = ({
  ...
  const handle_update_branch_hierarchy = async () => {
    ...
    try {
      ...
      const response = await api_update_branch_hierarchy(
        edit_data,
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Branch Hierarchy Update
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Branch Hierarchy. Once edited, it will
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_branch_hierarchy}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Branch Hierarchy</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-5">
              <div>
                <Text_Code_Field
                  ...
                  code_value={edit_data.branch_code}
                  text_value={get_description(
                    edit_data.branch_code,
                    branch_list,
                    "branch_code",
                    "branch_desc"
                  )}
