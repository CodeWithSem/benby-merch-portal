...
import { api_update_sales_org_hierarchy } from "api/firestore_db/maintenance/data_assignment/tbl_sales_org_hierarchy_api";
...
const Edit_Sales_Org_H = ({
  ...
  const handle_update_sales_org_hierarchy = async () => {
    ...
    try {
      ...
      const response = await api_update_sales_org_hierarchy(
        edit_data,
        active_user?.username
      );
      if (response.success) {
        console_log(response.data);
        set_sales_org_hierarchy_list((prev) =>
          prev.map((item) =>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-base font-bold mb-4">
              Confirm Sales Organization Hierarchy Update
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Sales Organization Hierarchy. Once
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_sales_org_hierarchy}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Sales Organization Hierarchy</h1>
            </div>
...
export default Edit_Sales_Org_H;
