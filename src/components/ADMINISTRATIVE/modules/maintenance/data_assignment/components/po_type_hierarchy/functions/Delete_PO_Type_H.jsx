...
import { api_delete_po_type_hierarchy } from "api/firestore_db/maintenance/data_assignment/tbl_po_type_hierarchy_api";
...
const Delete_PO_Type_H = ({
  ...
  const handle_delete_po_type_hierarchy = async (id) => {
    try {
      set_delete_loading(true);

      const response = await api_delete_po_type_hierarchy(id);
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Delete PO Type Hierarchy
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to delete this PO Type Hierarchy.
            </p>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={() => handle_delete_po_type_hierarchy(delete_data.id)}
              >
                Yes
              </Button>
              <Button
            ...
            <div className="w-full">
              <div className="w-full bg-white rounded-lg border">
                <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                  <h1 className="text-lg">PO Type Hierarchy Details</h1>
...
export default Delete_PO_Type_H;
