...
const Select_Sales_Org_H = ({
  ...
  }, [sales_org_h_list, search_query, current_page, rows_per_page]);
  ...
  const handle_select_sales_org = () => {
    ...
    set_data((prev) => ({
      ...prev,
      sales_org_code: selected_sales_org_h.sales_org_code,
      dist_channel_code: selected_sales_org_h.dist_channel_code,
    }));
    on_close();
  };
