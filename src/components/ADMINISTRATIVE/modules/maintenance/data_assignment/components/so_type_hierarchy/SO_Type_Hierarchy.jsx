...
import { api_get_sales_org_hierarchy_list } from "api/firestore_db/maintenance/data_assignment/tbl_sales_org_hierarchy_api";
...
import Create_SO_Type_H from "./functions/Create_SO_Type_H";
import Edit_SO_Type_H from "./functions/Edit_SO_Type_H";
import Delete_SO_Type_H from "./functions/Delete_SO_Type_H";
...
const SO_Type_Hierarchy = ({ set_page }) => {
  ...
  const [sales_org_h_list, set_sales_org_h_list] = useState([]);
  ...
  const handle_get_all_lists = async () => {
    try {
      const [
        so_type_response,
        sales_org_response,
        dist_channel_response,
        sales_org_h_response,
      ] = await Promise.all([
      ...
      if (so_type_response.success && sales_org_h_response.success) {
        ...
        set_sales_org_h_list(sales_org_h_response.data);
        set_display_modal("");
      } else {
        console.error("One or more list fetches failed.", {
          ...
          sales_org_h: sales_org_h_response.message,
        });
        show_error();
        handle_go_back("main");
      }
  ...
  const def_so_type_hierarchy_data = {
    id: null,
    so_type_code: "",
    sales_org_code: "",
    dist_channel_code: "",
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_SO_TYPE_HIERARCHY", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
      }));
  ...
  const [so_type_hierarchy_list, set_so_type_hierarchy_list] = useState([]);

  const handle_get_so_type_hierarchy_list = async () => {
    set_loading_list(true);
    const response = await api_get_so_type_hierarchy_list();
    if (response.success) {
      set_so_type_hierarchy_list(response.data);
    } else {
  ...
  const handle_truncate_so_type_hierarchy_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_so_type_hierarchy();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_so_type_hierarchy_list, set_filtered_so_type_hierarchy_list] =
    useState([]);
  ...
  useEffect(() => {
    let temp = [...so_type_hierarchy_list];
    ...
    set_filtered_so_type_hierarchy_list(indexed_data);
  }, [
    so_type_hierarchy_list,
    debounced_query,
    sort_by,
    sort_order,
    current_page,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ? so_type_hierarchy_list.filter((u) => {
          const q = debounced_query.toLowerCase();
      ...
      : so_type_hierarchy_list.length) / select_option
  );
  ...
  const handle_create_new_so_type_hierarchy = () => {
    set_sub_page("create_new_so_type_hierarchy");
  };

  const handle_edit_so_type_hierarchy = (data) => {
    set_edit_data(data);
    set_sub_page("edit_so_type_hierarchy");
  };
  const handle_delete_so_type_hierarchy = (data) => {
    set_delete_data(data);
    set_display_modal("delete_so_type_hierarchy");
  };

  const handle_upload_so_type_hierarchy = () => {
    set_sub_page("upload_so_type_hierarchy");
  };
  ...
  return (
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">SO Type Hierarchy</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
                ...
                <div className="flex gap-2">
                  ...
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_so_type_hierarchy_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_so_type_hierarchy}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_so_type_hierarchy}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_so_type_hierarchy_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_so_type_hierarchy_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_so_type_hierarchy_list.map((row, idx) => {
                                  ...
                                  <div className="flex gap-2">
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() =>
                                          handle_edit_so_type_hierarchy(row)
                                        }
                                      >
                                        <Edit size={19} />
                                      </button>
                                    ...
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() =>
                                          handle_delete_so_type_hierarchy(row)
                                        }
                                      >
                                        <Trash size={19} />
                                      </button>
      ...
      {sub_page === "create_new_so_type_hierarchy" && (
        <Create_SO_Type_H
          ...
          set_so_type_hierarchy_list={set_so_type_hierarchy_list}
      ...
      {sub_page === "edit_so_type_hierarchy" && (
        <Edit_SO_Type_H
          handle_go_back={handle_go_back}
          active_user={active_user}
          reset_new_data={reset_new_data}
      ...
      {sub_page === "upload_so_type_hierarchy" && (
        <Upload_SO_Type_H
          handle_go_back={handle_go_back}
          handle_get_so_type_hierarchy_list={handle_get_so_type_hierarchy_list}
          show_toast={show_toast}
          so_type_list={so_type_list}
          sales_org_list={sales_org_list}
          dist_channel_list={dist_channel_list}
      ...
      <Delete_SO_Type_H
        is_open={display_modal === "delete_so_type_hierarchy"}
...
export default SO_Type_Hierarchy;
