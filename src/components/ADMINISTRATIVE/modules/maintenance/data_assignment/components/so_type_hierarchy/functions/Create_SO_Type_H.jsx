...
import { api_create_so_type_hierarchy } from "api/firestore_db/maintenance/data_assignment/tbl_so_type_hierarchy_api";
...
const Create_SO_Type_H = ({
  ...
  const handle_create_so_type_hierarchy = async () => {
    ...
    try {
      ...
      const response = await api_create_so_type_hierarchy(
        new_data,
        active_user?.username
      );
      if (response.success) {
        console_log(response.data);
        set_so_type_hierarchy_list((prev) => [...prev, response.data]);
        show_status("success");
        reset_new_data();
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm SO Type Hierarchy Creation
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to create a new SO Type Hierarchy. Once created, it
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_create_so_type_hierarchy}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">SO Type Hierarchy Creation</h1>
            </div>
...
export default Create_SO_Type_H;
