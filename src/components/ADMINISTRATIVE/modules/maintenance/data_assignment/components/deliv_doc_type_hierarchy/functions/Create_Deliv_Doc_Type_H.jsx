...
const Create_Deliv_Doc_Type_H = ({
  ...
  const handle_create_deliv_doc_type_hierarchy = async () => {
    ...
    try {
      ...
      const response = await api_create_deliv_doc_type_hierarchy(
        new_data,
      ...
      if (response.success) {
        ...
        set_deliv_doc_type_hierarchy_list((prev) => [...prev, response.data]);
        reset_new_data();
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-base font-bold mb-4">
              Confirm Delivery Document Type Hierarchy Creation
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to create a new Delivery Document Type Hierarchy.
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_create_deliv_doc_type_hierarchy}
              >
                Yes
              </Button>
              <Button
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg">
                Delivery Document Type Hierarchy Creation
              </h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-5">
              ...
              <div>
                <Text_Code_Field
                  ...
                  code_width="150px"
                  show_search_button={true}
                  code_value={new_data.so_type_code}
                  text_value={get_description(
                    new_data.so_type_code,
                    so_type_list,
                    "so_type_code",
                    "so_type_desc"
                  )}
...
export default Create_Deliv_Doc_Type_H;
