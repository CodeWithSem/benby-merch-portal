...
import { api_delete_deliv_doc_type_hierarchy } from "api/firestore_db/maintenance/data_assignment/tbl_deliv_doc_type_hierarchy_api";
...
const Delete_Deliv_Doc_Type_H = ({
  ...
  const handle_delete_deliv_doc_type_hierarchy = async (id) => {
    try {
      set_delete_loading(true);

      const response = await api_delete_deliv_doc_type_hierarchy(id);
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-base font-bold mb-4">
              Delete Delivery Document Type Hierarchy
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to delete this Delivery Document Type Hierarchy.
            </p>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={() =>
                  handle_delete_deliv_doc_type_hierarchy(delete_data.id)
                }
              >
                Yes
              </Button>
              ...
              <div className="w-full bg-white rounded-lg border">
                <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                  <h1 className="text-lg">
                    Delivery Document Type Hierarchy Details
                  </h1>
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    ...
                    <div>
                      <Text_Code_Field
                        ...
                        code_width="150px"
                        show_search_button={false}
                        code_value={delete_data.so_type_code}
                        text_value={get_description(
                          delete_data.so_type_code,
                          so_type_list,
                          "so_type_code",
                          "so_type_desc"
                        )}
...
export default Delete_Deliv_Doc_Type_H;
