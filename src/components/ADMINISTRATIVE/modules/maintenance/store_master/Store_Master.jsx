...
import {
  get_all_store_master,
  truncate_store_master,
} from "api/real_time_db/maintenance/store_master_api";
import Upload_Store from "./upload/Upload_Store";
...
const Store_Master = () => {
  ...
  const columns = [
    ...
    { key: "a1_cstCode", label: "STORE CODE", sortable: true },
    { key: "a2_cstName1", label: "STORE NAME 1", sortable: true },
    { key: "a3_cstName2", label: "STORE NAME 2", sortable: true },
    { key: "b1_chain", label: "CHAIN", sortable: true },
    { key: "b2_chainID", label: "CHAIN ID", sortable: true },
  ];
  ...
  const [store_master_list, set_store_master_list] = useState([]);

  const handle_get_store_master_list = async () => {
    try {
      set_loading(true);
      const response = await get_all_store_master();
      set_store_master_list(response);
      set_current_page(1);
    } catch (error) {
  ...
  const {
    ...
    filtered_data,
    total_pages,
  } = client_side_filter(store_master_list, columns);
  ...
  const handle_truncate = async () => {
    try {
      ...
      const result = await truncate_store_master((progress) => {
  ...
  return (
    <React.Fragment>
          ...
          <div className="w-full">
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    ...
                    <span className="text-gray-800">Store Master</span>
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div className="w-full bg-white rounded-lg border">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <h1 className="text-lg">Store Master</h1>
                  ...
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_store_master_list}
                      />
                    </div>
      ...
      {/* + PAGES */}
      {page === "upload_mcp" && <Upload_Store set_page={set_page} />}
      {/* - PAGES */}
      {/* + MODALS */}
      <Truncate_Modal
      ...
      <Confirm_Modal
        ...
        description_1="Are you sure you want to delete all Store Master data?"
