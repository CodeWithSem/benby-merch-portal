...
const Delete_Move_Type = ({
  ...
  const handle_delete_move_type = () => {
    alert("Delete Movement Type");
  };
          ...
          >
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                width="w-[100px]"
                variant="danger"
                on_click={handle_delete_move_type}
              >
                Yes
              </Button>
              <Button
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    <div className="col-span-full">
                      <Text_Field
                        ...
                        type={"text"}
                        value={delete_data.move_type_code}
                        pattern="[A-Za-z]{1,}"
                        disabled
                      />
                    </div>
                    <div className="col-span-full">
                      <Text_Field
                        ...
                        type={"text"}
                        value={delete_data.move_type_desc}
                        pattern="[A-Za-z]{1,}"
                        disabled
                      />
                    </div>
