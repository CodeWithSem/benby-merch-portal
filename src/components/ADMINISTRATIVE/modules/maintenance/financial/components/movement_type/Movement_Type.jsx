...
const Movement_Type = ({ set_page }) => {
  ...
  const columns = [
    ...
    { key: "move_type_code", label: "Movement Type Code", sortable: true },
    {
      key: "move_type_desc",
  ...
  // --- State ---
  const [move_type_list, set_move_type_list] = useState([
    {
      id: 1,
      move_type_code: "MT-001",
      move_type_desc: "Movement Type Description 1",
      created_by: "Admin",
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : move_type_list.length) / select_option
  );
  // - Total page of Pagination
  ...
  const handle_create_new_move_type = () => {
    set_sub_page("create_new_move_type");
  };

  const handle_edit_move_type = (data) => {
    set_edit_data(data);
    set_sub_page("edit_move_type");
  };
  const handle_delete_move_type = (data) => {
    set_delete_data(data);
    set_display_modal("delete_move_type");
  };
  ...
  return (
    <React.Fragment>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_move_type}
                  >
                    Create New Data
                  </Button>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_move_type(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_move_type" && (
        <Create_Move_Type handle_go_back={handle_go_back} />
      )}
      {sub_page === "edit_move_type" && (
        <Edit_Move_Type
      ...
      <Delete_Move_Type
        is_open={display_modal === "delete_move_type"}
