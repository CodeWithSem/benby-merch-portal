...
import Create_Exc_Rate from "./functions/Create_Exc_Rate";
import Edit_Exc_Rate from "./functions/Edit_Exc_Rate";
import Delete_Exc_Rate from "./functions/Delete_Exc_Rate";
...
const Exchange_Rate = ({ set_page }) => {
  ...
  const [exchange_rate_list, set_exchange_rate_list] = useState([
    {
      id: 1,
      exchange_rate_code: "USD-PH",
      exchange_rate_desc: "US Dollar to Philippine Peso",
      created_by: "Admin",
  ...
  return (
    <React.Fragment>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_exchange_rate(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_exchange_rate" && (
        <Create_Exc_Rate handle_go_back={handle_go_back} />
      )}
