...
import Create_Pay_Method from "./functions/Create_Pay_Method";
import Edit_Pay_Method from "./functions/Edit_Pay_Method";
import Delete_Pay_Method from "./functions/Delete_Pay_Method";
  ...
  return (
    <React.Fragment>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_payment_method(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_payment_method" && (
        <Create_Pay_Method handle_go_back={handle_go_back} />
      )}
