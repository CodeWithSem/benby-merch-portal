...
import Create_Pay_Terms from "./functions/Create_Pay_Terms";
import Edit_Pay_Terms from "./functions/Edit_Pay_Terms";
import Delete_Pay_Terms from "./functions/Delete_Pay_Terms";

const Payment_Terms = ({ set_page }) => {
  // + Variables
  ...
  return (
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Payment Terms</span>
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div className="w-full bg-white rounded-lg border">
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h1 className="text-lg">Payment Terms</h1>
                </div>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_payment_term(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_payment_term" && (
        <Create_Pay_Terms handle_go_back={handle_go_back} />
      )}
