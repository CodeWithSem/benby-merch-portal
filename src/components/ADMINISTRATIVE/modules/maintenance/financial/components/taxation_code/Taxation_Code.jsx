...
import Create_Bus_Area from "./functions/Create_Tax_Code";
import Edit_Bus_Area from "./functions/Edit_Tax_Code";
import Delete_Bus_Area from "./functions/Delete_Tax_Code";

const Taxation_Code = ({ set_page }) => {
  // + Variables
  ...
  return (
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Taxation Code</span>
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div className="w-full bg-white rounded-lg border">
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h1 className="text-lg">Taxation Code</h1>
                </div>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_taxation(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_taxation" && (
        <Create_Bus_Area handle_go_back={handle_go_back} />
      )}
