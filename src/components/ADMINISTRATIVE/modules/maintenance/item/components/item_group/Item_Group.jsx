...
import {
  ...
  api_set_item_group_increment,
  api_truncate_item_group,
} from "api/firestore_db/maintenance/item/tbl_item_group_api";
import {
  Search,
  ChevronDown,
  ChevronUp,
  ...
  return (
    <React.Fragment>
      ...
      <Set_Increment_ID
        ...
        api_set_increment_id={api_set_item_group_increment}
      />
    </React.Fragment>
  );
};
