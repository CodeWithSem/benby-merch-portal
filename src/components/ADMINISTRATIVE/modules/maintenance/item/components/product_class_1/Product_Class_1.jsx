// File Name: Product_Class_1
// Function Name: Product_Class_1
// Data Name: product_class_1
// Column Name: Product Class 1
// Table Name: TBL_PRODUCT_CLASS_1
// Title Name: Product Class 1
...
} from "api/firestore_db/tbl_product_class_1_api";
...
import Create_Product_Class_1 from "./functions/Create_Product_Class_1";
...
const Product_Class_1 = ({ set_page }) => {
  ...
  const def_product_class_1_data = {
    id: null,
    product_class_1_code: "",
    product_class_1_desc: "",
    creation_date: "",
    created_by: "",
    change_date: "",
    change_by: "",
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_PRODUCT_CLASS_1", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
  ...
  const columns = [
    ...
    {
      key: "product_class_1_code",
      label: "Product Class 1 Code",
      sortable: true,
    },
    {
      key: "product_class_1_desc",
      label: "Product Class 1 Description",
      sortable: true,
    },
  ...
  const [product_class_1_list, set_product_class_1_list] = useState([]);

  const handle_get_product_class_1_list = async () => {
    set_loading_list(true);
    const response = await api_get_product_class_1_list();
    if (response.success) {
      set_product_class_1_list(response.data);
    } else {
  ...
  const handle_truncate_product_class_1_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_product_class_1();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_product_class_1_list, set_filtered_product_class_1_list] =
    useState([]);
  ...
  useEffect(() => {
    ...
    set_filtered_product_class_1_list(indexed_data);
  }, [
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : product_class_1_list.length) / select_option
  );
  ...
  const handle_create_new_product_class_1 = () => {
    set_sub_page("create_new_product_class_1");
  };

  const handle_edit_product_class_1 = (data) => {
    set_edit_data(data);
    set_sub_page("edit_product_class_1");
  };
  const handle_delete_product_class_1 = (data) => {
    set_delete_data(data);
    set_display_modal("delete_product_class_1");
  };

  const handle_upload_product_class_1 = () => {
    set_sub_page("upload_product_class_1");
  };
  ...
  return (
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Product Class 1</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
                ...
                <div className="flex gap-2">
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_product_class_1_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_product_class_1}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_product_class_1}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_product_class_1_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_product_class_1_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_product_class_1_list.map((row, idx) => {
                            // + Cell Renderer
                                  ...
                                  <div className="flex gap-2">
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() =>
                                          handle_edit_product_class_1(row)
                                        }
                                      >
                                        <Edit size={19} />
                                      </button>
                                    ...
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() =>
                                          handle_delete_product_class_1(row)
                                        }
                                      >
                                        <Trash size={19} />
                                      </button>
      ...
      {sub_page === "create_new_product_class_1" && (
        <Create_Product_Class_1
      ...
      {sub_page === "edit_product_class_1" && (
        <Edit_Product_Class_1
          handle_go_back={handle_go_back}
          active_user={active_user}
          show_toast={show_toast}
          edit_data={edit_data}
      ...
      {sub_page === "upload_product_class_1" && (
        <Upload_Product_Class_1
          handle_go_back={handle_go_back}
          handle_get_product_class_1_list={handle_get_product_class_1_list}
          show_toast={show_toast}
        />
      )}
      <Delete_Product_Class_1
        is_open={display_modal === "delete_product_class_1"}
...
export default Product_Class_1;
