...
import Delete_PO_Type from "./functions/Delete_PO_Type.jsx";
  ...
  return (
    <React.Fragment>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_po_type(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_po_type" && (
        <Create_PO_Type handle_go_back={handle_go_back} />
      )}
