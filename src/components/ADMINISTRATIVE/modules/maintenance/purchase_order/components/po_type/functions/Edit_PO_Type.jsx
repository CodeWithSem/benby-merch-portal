...
const Edit_PO_Type = ({
  ...
  const validate_edit_data = () => {
    ...
    if (!edit_data.po_type_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_update_po_type = async () => {
    ...
    try {
      ...
      const response = await api_update_po_type(
        edit_data,
        active_user?.username
      );
      if (response.success) {
        console_log(response.data);
        set_po_type_list((prev) =>
          prev.map((item) =>
      ...
      console.error("Failed to create po_type:", error);
      show_status("error");
    } finally {
      close_confirm_modal();
    }
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Purchase Order Type Update
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Purchase Order Type. Once edited, it
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_po_type}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Purchase Order Type</h1>
            </div>
