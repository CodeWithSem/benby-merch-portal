...
import { api_create_truck_type } from "api/firestore_db/maintenance/truck/tbl_truck_type_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Create_Truck_Type = ({
  ...
  const validate_new_data = () => {
    if (!new_data.truck_type_code.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
    ...
    if (!new_data.truck_type_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_create_truck_type = async () => {
    ...
    try {
      ...
      const response = await api_create_truck_type(
        new_data,
        active_user?.username
      );
      if (response.success) {
        console_log(response.data);
        set_truck_type_list((prev) => [...prev, response.data]);
        show_status("success");
        reset_new_data();
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Truck Type Creation
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to create a new Truck Type. Once created, it will be
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_create_truck_type}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Truck Type Creation</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-x 0 lg:gap-x-5 gap-y-5 lg:grid-cols-3">
              <div>
                <Text_Field
                  ...
                  type={"text"}
                  value={new_data.truck_type_code || ""}
                  disabled
                />
              </div>
              <div className="col-span-2">
                <Text_Field
                  ...
                  value={new_data.truck_type_desc || ""}
                  on_change={(e) =>
...
export default Create_Truck_Type;
