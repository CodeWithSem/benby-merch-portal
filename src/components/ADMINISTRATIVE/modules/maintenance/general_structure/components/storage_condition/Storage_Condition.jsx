...
const Storage_Condition = ({ set_page }) => {
  ...
  const columns = [
    ...
    { key: "scon_code", label: "SCON Code", sortable: true },
    { key: "scon_desc", label: "SCON Description", sortable: true },
  ...
  return (
    <React.Fragment>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_scon(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_scon" && (
        <Create_SCON handle_go_back={handle_go_back} />
      )}
      {sub_page === "edit_scon" && (
        <Edit_SCON
