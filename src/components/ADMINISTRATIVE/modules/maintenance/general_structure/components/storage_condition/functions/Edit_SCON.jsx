...
import { api_update_scon } from "api/firestore_db/tbl_scon_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Edit_SCON = ({
  ...
  const handle_change_scon_desc = (value) => {
    set_edit_data({
      ...edit_data,
      scon_desc: value,
    });
  ...
  const handle_update_scon = async () => {
    ...
    try {
      ...
      const response = await api_update_scon(edit_data, active_user?.username);
      if (response.success) {
      ...
      console.error("Failed to create scon:", error);
      show_status("error");
    } finally {
      close_confirm_modal();
    }
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Storage Condition Update
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Storage Condition. Once edited, it will
          ...
          <nav>
            <ol className="flex flex-wrap items-center gap-1.5">
              ...
              <li className="flex items-center gap-1.5 text-sm text-gray-500">
                <span>/</span>
                <span className="text-gray-800">Edit Storage Condition</span>
              </li>
            </ol>
          </nav>
          {/* - Breadcrumbs */}
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Storage Condition</h1>
            </div>
