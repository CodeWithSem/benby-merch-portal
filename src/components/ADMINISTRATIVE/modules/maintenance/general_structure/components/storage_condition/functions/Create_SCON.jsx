...
import { api_create_scon } from "api/firestore_db/maintenance/general_structure/tbl_scon_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Create_SCON = ({
  ...
  const handle_create_scon = async () => {
    ...
    try {
      ...
      const response = await api_create_scon(new_data, active_user?.username);
      if (response.success) {
        console_log(response.data);
        set_scon_list((prev) => [...prev, response.data]);
        show_status("success");
        reset_new_data();
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Storage Condition Creation
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to create a new Storage Condition. Once created, it
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Storage Condition Creation</h1>
            </div>
