...
import { api_create_purc_group } from "api/firestore_db/maintenance/general_structure/tbl_purc_group_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Create_P_Group = ({
  ...
  const validate_new_data = () => {
    ...
    if (!new_data.purc_group_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_create_purc_group = async () => {
    ...
    try {
      ...
      const response = await api_create_purc_group(
        new_data,
      ...
      if (response.success) {
        ...
        set_purc_group_list((prev) => [...prev, response.data]);
        reset_new_data();
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Purchasing Group Creation
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to create a new Purchasing Group. Once created, it
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_create_purc_group}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Purchasing Group Creation</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-x 0 lg:gap-x-5 gap-y-5 lg:grid-cols-3">
              <div>
                <Text_Field
                  ...
                  type={"text"}
                  value={new_data.purc_group_code || ""}
                  disabled
                />
              </div>
              <div className="col-span-2">
                <Text_Field
                  ...
                  value={new_data.purc_group_desc || ""}
                  on_change={(e) =>
