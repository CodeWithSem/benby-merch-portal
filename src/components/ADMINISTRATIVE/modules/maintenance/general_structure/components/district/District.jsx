...
const District = ({ set_page }) => {
  ...
  const columns = [
    ...
    { key: "district_desc", label: "District Description", sortable: true },
  ...
  return (
    <React.Fragment>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_district(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_district" && (
        <Create_District handle_go_back={handle_go_back} />
      )}
