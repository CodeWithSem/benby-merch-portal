...
const Purchase_Org = ({ set_page }) => {
  ...
  const columns = [
    ...
    { key: "p_org_code", label: "Purchase Org Code", sortable: true },
  ...
  // --- State ---
  const [p_org_list, set_p_org_list] = useState([
    {
      id: 1,
      p_org_code: "P-ORG-001",
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : p_org_list.length) / select_option
  );
  // - Total page of Pagination
  ...
  const handle_create_new_p_org = () => {
    set_sub_page("create_new_p_org");
  };

  const handle_edit_p_org = (data) => {
    set_edit_data(data);
    set_sub_page("edit_p_org");
  };
  const handle_delete_p_org = (data) => {
    set_delete_data(data);
    set_display_modal("delete_p_org");
  };
  ...
  return (
    <React.Fragment>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_p_org}
                  >
                    Create New Data
                  </Button>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_p_org(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
                                    ...
                                    <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        onClick={() => handle_delete_p_org(row)}
                                      >
                                        <Trash size={19} />
                                      </button>
      ...
      {sub_page === "create_new_p_org" && (
        <Create_P_Org handle_go_back={handle_go_back} />
      )}
      {sub_page === "edit_p_org" && (
        <Edit_P_Org
      ...
      <Delete_P_Org
        is_open={display_modal === "delete_p_org"}
