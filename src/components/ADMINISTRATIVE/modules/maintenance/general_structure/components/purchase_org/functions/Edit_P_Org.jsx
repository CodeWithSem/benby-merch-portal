...
const Edit_P_Org = ({
  ...
  const validate_edit_data = () => {
    ...
    if (!edit_data.purc_org_desc.trim()) {
      show_toast({
        type: "danger",
        title: "Invalid",
  ...
  const handle_update_purc_org = async () => {
    ...
    try {
      ...
      const response = await api_update_purc_org(
        edit_data,
      ...
      console.error("Failed to create purc_org:", error);
    } finally {
      close_confirm_modal();
    }
  };
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            <div className="w-full flex justify-center items-center text-lg md:text-xl font-bold mb-4">
              Confirm Purchasing Organization Update
            </div>
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to edit this Purchasing Organization. Once edited,
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                ...
                on_click={handle_update_purc_org}
              >
                Yes
              </Button>
              <Button
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Edit Purchasing Organization</h1>
            </div>
