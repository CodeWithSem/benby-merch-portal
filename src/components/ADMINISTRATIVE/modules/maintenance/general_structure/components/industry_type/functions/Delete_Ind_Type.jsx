...
const Delete_Ind_Type = ({
  ...
  const handle_delete_ind_type = () => {
    alert("Delete Industry Type");
  };
          ...
          >
            ...
            <div className="flex justify-center gap-2 mt-4">
              <Button
                width="w-[100px]"
                variant="danger"
                on_click={handle_delete_ind_type}
              >
                Yes
              </Button>
              <Button
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    <div className="col-span-full">
                      <Text_Field
                        ...
                        type={"text"}
                        value={delete_data.ind_type_code}
                        pattern="[A-Za-z]{1,}"
                        disabled
                      />
                    </div>
                    <div className="col-span-full">
                      <Text_Field
                        ...
                        type={"text"}
                        value={delete_data.ind_type_desc}
                        pattern="[A-Za-z]{1,}"
                        disabled
                      />
                    </div>
...
export default Delete_Ind_Type;
