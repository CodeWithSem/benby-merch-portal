...
const Edit_Ind_Type = ({ handle_go_back, edit_data, set_edit_data }) => {
  const handle_change_ind_type_desc = (value) => {
    set_edit_data({
      ...edit_data,
      ind_type_desc: value,
    });
