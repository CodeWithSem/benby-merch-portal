...
import {
  ...
  api_set_language_increment,
  api_truncate_language,
} from "api/firestore_db/maintenance/general_structure/tbl_language_api";
import {
  Search,
  ChevronDown,
  ChevronUp,
...
import Upload_Language from "./functions/Upload_Language";
...
const Language = ({ set_page }) => {
  ...
  const [new_data, set_new_data] = useState({ ...def_language_data });
  const [edit_data, set_edit_data] = useState({ ...def_language_data });
  const [delete_data, set_delete_data] = useState({ ...def_language_data });
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_LANGUAGE", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
      }));
  ...
  // ======================================================
  // id: 1,
  // language_code: "Language-001",
  // language_desc: "Language Description 1",
  // created_by: "Admin",
  ...
  const handle_get_language_list = async () => {
    set_loading_list(true);
    const response = await api_get_language_list();
    if (response.success) {
      set_language_list(response.data);
    } else {
  ...
  useEffect(() => {
    handle_get_language_list();
  }, []);

  const handle_truncate_language_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_language();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_language_list, set_filtered_language_list] = useState([]);
  ...
  useEffect(() => {
    ...
    set_filtered_language_list(indexed_data);
  }, [
    language_list,
    debounced_query,
    sort_by,
  ...
  const handle_upload_language = () => {
    set_sub_page("upload_language");
  };
  ...
  return (
    <React.Fragment>
                ...
                <div className="flex gap-2">
                  ...
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_language_list}
                    >
                      Truncate
                    </Button>
                  )}
                  ...
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_language}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_language_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_language_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_language_list.map((row, idx) => {
                            // + Cell Renderer
      ...
      {sub_page === "upload_language" && (
        <Upload_Language
          handle_go_back={handle_go_back}
          handle_get_language_list={handle_get_language_list}
          show_toast={show_toast}
        />
      )}
      <Delete_Language
      ...
      <Set_Increment_ID
        ...
        api_set_increment_id={api_set_language_increment}
      />
    </React.Fragment>
  );
};
