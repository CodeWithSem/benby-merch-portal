...
const Country = ({ set_page }) => {
  ...
  const columns = [
    ...
    { key: "country_desc", label: "Country Description", sortable: true },
  ...
  const [country_list, set_country_list] = useState([
    {
      id: 1,
      country_code: "PH",
      country_desc: "Philippines Numba Wan",
      created_by: "Admin",
  ...
  return (
    <React.Fragment>
                                  ...
                                  <div className="flex gap-2">
                                    {/* <div className="relative group flex jusity-center items-center">
                                      <button
                                        ...
                                        // onClick={() => handle_view_country(row.id)}
                                      >
                                        <View size={19} />
                                      </button>
      ...
      {sub_page === "create_new_country" && (
        <Create_Country handle_go_back={handle_go_back} />
      )}
