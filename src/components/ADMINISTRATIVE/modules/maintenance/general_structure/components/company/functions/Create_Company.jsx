...
import { api_create_company } from "api/firestore_db/maintenance/general_structure/tbl_company_api";
import {
  console_log,
  format_date_1,
  get_date_now,
  ...
  const handle_create_company = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        set_company_list((prev) => [...prev, response.data]);
        reset_new_data();
