...
const Stock_Type = ({ set_page }) => {
  ...
  const [new_data, set_new_data] = useState({ ...def_stock_type_data });
  const [edit_data, set_edit_data] = useState({ ...def_stock_type_data });
  const [delete_data, set_delete_data] = useState({ ...def_stock_type_data });
  ...
  useEffect(() => {
    Get_TBL_INCREMENTAL_ID("TBL_STOCK_TYPE", (value) => {
      set_new_data((prev) => ({
        ...prev,
        id: value,
        stock_type_code: `STK-T-${String(value).padStart(2, "0")}`,
      }));
  ...
  const columns = [
    ...
    { key: "stock_type_code", label: "Stock Type Code", sortable: true },
    {
      key: "stock_type_desc",
  ...
  const [stock_type_list, set_stock_type_list] = useState([]);
  // ======================================================
  // id: 1,
  // stock_type_code: "PL-S-001",
  // stock_type_desc: "Stock Type Description 1",
  // created_by: "Admin",
  ...
  const handle_get_stock_type_list = async () => {
    set_loading_list(true);
    const response = await api_get_stock_type_list();
    if (response.success) {
      set_stock_type_list(response.data);
    } else {
  ...
  useEffect(() => {
    handle_get_stock_type_list();
  }, []);

  const handle_truncate_stock_type_list = async () => {
    set_truncate_loading(true);
    const response = await api_truncate_stock_type();
    if (response.success) {
      show_toast({
        type: "success",
  ...
  const [filtered_stock_type_list, set_filtered_stock_type_list] = useState([]);
  ...
  useEffect(() => {
    ...
    set_filtered_stock_type_list(indexed_data);
  }, [
    stock_type_list,
    debounced_query,
    sort_by,
  ...
  const total_pages = Math.ceil(
    (debounced_query
      ...
      : stock_type_list.length) / select_option
  );
  ...
  const handle_create_new_stock_type = () => {
    set_sub_page("create_new_stock_type");
  };

  const handle_edit_stock_type = (data) => {
    set_edit_data(data);
    set_sub_page("edit_stock_type");
  };
  const handle_delete_stock_type = (data) => {
    set_delete_data(data);
    set_display_modal("delete_stock_type");
  };

  const handle_upload_stock_type = () => {
    set_sub_page("upload_stock_type");
  };
    ...
    <React.Fragment>
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">Stock Type</span>
                  </li>
                </ol>
              </nav>
              {/* - Breadcrumbs */}
            ...
            <div className="w-full bg-white rounded-lg border">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <div className="flex items-center gap-3">
                  ...
                  ></Button>
                  <h1 className="text-lg">Stock Type</h1>
                </div>
                <div className="flex gap-2">
                  ...
                  {active_user?.category === "DEV" && (
                    <Button
                      ...
                      on_click={handle_truncate_stock_type_list}
                    >
                      Truncate
                    </Button>
                  )}
                  <Button
                    ...
                    icon={PlusCircle}
                    icon_position="left"
                    on_click={handle_create_new_stock_type}
                  >
                    Create New Data
                  </Button>
                  <Button
                    ...
                    icon={FileUp}
                    icon_position="left"
                    on_click={handle_upload_stock_type}
                  >
                    Upload
                  </Button>
                </div>
              ...
              <div className="p-5 sm:p-6 border-t">
                <div className="w-full border rounded-lg">
                  <div className="w-full md:flex md:justify-between p-4 gap-4">
                    <div className="flex items-center text-sm gap-2">
                      ...
                      <Button
                        ...
                        icon={RefreshCw}
                        icon_position="left"
                        on_click={handle_get_stock_type_list}
                      ></Button>
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {loading_list ? (
                    ...
                    ) : filtered_stock_type_list.length === 0 ? (
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {filtered_stock_type_list.map((row, idx) => {
                            // + Cell Renderer
      ...
      {sub_page === "create_new_stock_type" && (
        <Create_Stock_Type
          ...
          set_stock_type_list={set_stock_type_list}
        />
      )}
      ...
      <Set_Increment_ID
        ...
        api_set_increment_id={api_set_stock_type_increment}
      />
    </React.Fragment>
  );
};

export default Stock_Type;
