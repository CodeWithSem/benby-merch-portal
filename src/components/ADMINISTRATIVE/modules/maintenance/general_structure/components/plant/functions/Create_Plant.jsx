...
import { api_create_plant } from "api/firestore_db/tbl_plant_api";
import {
  console_log,
  format_date_1,
  get_date_now,
...
const Create_Plant = ({
  ...
  const handle_change_plant_desc = (value) => {
    set_new_data((prev) => ({
      ...prev,
      plant_desc: value,
    }));
  ...
  const handle_create_plant = async () => {
    ...
    try {
      ...
      const response = await api_create_plant(new_data, active_user?.username);
      if (response.success) {
        console_log(response.data);
        set_plant_list((prev) => [...prev, response.data]);
        show_status("success");
        reset_new_data();
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[100]">
          ...
          >
            ...
            <p className="w-full text-center text-sm leading-6 text-gray-500 dark:text-gray-400 pt-4">
              You are about to create a new Plant. Once created, it will be
          ...
          <nav>
            <ol className="flex flex-wrap items-center gap-1.5">
              ...
              <li className="flex items-center gap-1.5 text-sm text-gray-500">
                <span>/</span>
                <span className="text-gray-800">Create New Plant</span>
              </li>
            </ol>
          </nav>
          {/* - Breadcrumbs */}
        ...
        <div className="w-full bg-white rounded-lg border">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">Plant Creation</h1>
            </div>
