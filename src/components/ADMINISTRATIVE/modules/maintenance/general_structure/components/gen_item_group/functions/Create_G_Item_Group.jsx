...
const Create_G_Item_Group = ({ handle_go_back }) => {
  return (
    <React.Fragment>
        ...
        <div className="w-full bg-white rounded-lg border">
          <div className="flex flex-wrap items-center justify-between gap-3 p-5">
            <div className="flex items-center gap-3">
              ...
              ></Button>
              <h1 className="text-lg">General Item Group Creation</h1>
            </div>
...
export default Create_G_Item_Group;
