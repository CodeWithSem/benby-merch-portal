...
import Create_PL_Status from "./functions/Create_G_Item_Group";
import Edit_PL_Status from "./functions/Edit_G_Item_Group";
import Delete_PL_Status from "./functions/Delete_G_Item_Group";
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    <span>/</span>
                    <span className="text-gray-800">General Item Group</span>
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div className="w-full bg-white rounded-lg border">
              <div className="flex flex-wrap items-center justify-between gap-3 p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h1 className="text-lg">General Item Group</h1>
                </div>
