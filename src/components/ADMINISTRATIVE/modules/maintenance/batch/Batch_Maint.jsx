...
import Batch_Type from "./components/batch_type/Batch_Type";
import Period_Indicator from "./components/period_indicator/Period_Indicator";
...
const Batch_Maint = () => {
  ...
  const structure_list = [
    { key: "batch_type", icon: Package, title: "Batch Type" },
    { key: "period_ind", icon: Package, title: "Period Indicator" },
  ];
  ...
  return (
    <React.Fragment>
      ...
      {/* + Pages */}
      {page === "batch_type" && <Batch_Type set_page={set_page} />}
      {page === "period_ind" && <Period_Indicator set_page={set_page} />}
      {/* - Pages */}
    </React.Fragment>
  );
};

export default Batch_Maint;
