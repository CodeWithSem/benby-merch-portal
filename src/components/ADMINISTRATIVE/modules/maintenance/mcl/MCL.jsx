...
import {
  get_all_mcl_list,
  truncate_mcl,
} from "api/real_time_db/maintenance/mcl_api";
...
const MCL = () => {
  ...
  const handle_get_mcl_list = async () => {
    try {
      set_loading(true);
      const response = await get_all_mcl_list();
  ...
  const handle_truncate = async () => {
    try {
      ...
      const result = await truncate_mcl((progress) => {
              ...
              <nav>
                <ol className="flex flex-wrap items-center gap-1.5">
                  ...
                  <li className="flex items-center gap-1.5 text-sm text-gray-500">
                    ...
                    <span className="text-gray-800">MCL</span>
                  </li>
                </ol>
              </nav>
            </div>
