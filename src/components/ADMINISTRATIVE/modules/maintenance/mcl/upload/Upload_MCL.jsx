...
import { push_mcl_to_cloud } from "api/real_time_db/maintenance/mcl_api";

const Upload_MCL = ({ set_page }) => {
  ...
  const handle_fetch_data = async () => {
    ...
    try {
      const response = await axios.get(
        "https://benbyextportal.com/home/api/get/GetMCLRevamp2?Brand=0",
        {
  ...
  // 2. Inside the Upload_MCL component:
