...
import Create_Pricing_Proc from "./Create/Create_Pricing_Proc";

// import Create_Pricing_Procedure from "./create_pricing_procedure/Create_Pricing_Procedure";
// import Edit_Pricing_Procedure from "./edit_pricing_procedure/Edit_Pricing_Procedure";
// import View_Pricing_Procedure from "./view_pricing_procedure/View_Pricing_Procedure";
// import Delete_Pricing_Procedure from "./modals/delete_pricing_procedure/Delete_Pricing_Procedure";

/* MOCK API */
const api_get_pricing_procedure_list = async () => ({
  success: true,
  data: [
    {
      id: 1,
...
const Pricing_Procedure = () => {
  ...
  const handle_get_price_proc_list = async () => {
    ...
    const response = await api_get_pricing_procedure_list();
  ...
  return (
    <React.Fragment>
      ...
      {/* {page === "create" && <Create_Pricing_Procedure set_page={set_page} />}
      {page === "edit" && (
        <Edit_Pricing_Procedure set_page={set_page} edit_data={edit_data} />
      )}
      {page === "view" && (
        <View_Pricing_Procedure set_page={set_page} view_data={view_data} />
      )}

      <Delete_Pricing_Procedure
