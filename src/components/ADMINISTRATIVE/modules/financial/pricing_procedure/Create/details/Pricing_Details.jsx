        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <Text_Field
              ...
              type={"number"}
              placeholder="0"
              value={new_price_proc_data?.base_price}
          ...
          <div>
            <Find_Field
              label="Currency"
              value={new_price_proc_data?.currency}
          ...
          <div>
            <Date_Field
              ...
              on_change={handle_date_change_function("valid_from")}
            />
          </div>
          <div>
            <Date_Field
              ...
              on_change={handle_date_change_function("valid_to")}
            />
          </div>
        </div>
      </div>
